 ...
 *
 * @generated SignedSource<<8767f51134ae422df8bb47398094f81e>>
 */
...
fn regular_query_with_assignable_fragment_spread() {
    ...
    test_fixture(transform_fixture, "regular-query-with-assignable-fragment-spread.graphql", "generate_typescript/fixtures/regular-query-with-assignable-fragment-spread.expected", input, expected);
}
...
fn updatable_fragment_spread() {
    ...
    test_fixture(transform_fixture, "updatable-fragment-spread.graphql", "generate_typescript/fixtures/updatable-fragment-spread.expected", input, expected);
}
...
fn updatable_fragment_spread_and_regular_spread() {
    ...
    test_fixture(transform_fixture, "updatable-fragment-spread-and-regular-spread.graphql", "generate_typescript/fixtures/updatable-fragment-spread-and-regular-spread.expected", input, expected);
}
...
fn updatable_fragment_spread_multiple() {
    ...
    test_fixture(transform_fixture, "updatable-fragment-spread-multiple.graphql", "generate_typescript/fixtures/updatable-fragment-spread-multiple.expected", input, expected);
}
...
fn updatable_operation() {
    ...
    test_fixture(transform_fixture, "updatable-operation.graphql", "generate_typescript/fixtures/updatable-operation.expected", input, expected);
}
...
fn updatable_operation_assignable_fragment() {
    ...
    test_fixture(transform_fixture, "updatable-operation-assignable-fragment.graphql", "generate_typescript/fixtures/updatable-operation-assignable-fragment.expected", input, expected);
}
...
fn updatable_operation_assignable_fragment_plural() {
    ...
    test_fixture(transform_fixture, "updatable-operation-assignable-fragment-plural.graphql", "generate_typescript/fixtures/updatable-operation-assignable-fragment-plural.expected", input, expected);
}
...
fn updatable_operation_assignable_fragments_within_narrowing() {
    ...
    test_fixture(transform_fixture, "updatable-operation-assignable-fragments-within-narrowing.graphql", "generate_typescript/fixtures/updatable-operation-assignable-fragments-within-narrowing.expected", input, expected);
}
...
fn updatable_operation_multiple_assignable_fragments() {
    ...
    test_fixture(transform_fixture, "updatable-operation-multiple-assignable-fragments.graphql", "generate_typescript/fixtures/updatable-operation-multiple-assignable-fragments.expected", input, expected);
}
...
fn updatable_operation_plural_field_no_spreads() {
    ...
    test_fixture(transform_fixture, "updatable-operation-plural-field-no-spreads.graphql", "generate_typescript/fixtures/updatable-operation-plural-field-no-spreads.expected", input, expected);
}
...
fn updatable_operation_plural_field_with_spreads() {
    ...
    test_fixture(transform_fixture, "updatable-operation-plural-field-with-spreads.graphql", "generate_typescript/fixtures/updatable-operation-plural-field-with-spreads.expected", input, expected);
}
...
fn updatable_operation_special_fields() {
    ...
    test_fixture(transform_fixture, "updatable-operation-special-fields.graphql", "generate_typescript/fixtures/updatable-operation-special-fields.expected", input, expected);
}
...
fn updatable_operation_type_refinement() {
    ...
    test_fixture(transform_fixture, "updatable-operation-type-refinement.graphql", "generate_typescript/fixtures/updatable-operation-type-refinement.expected", input, expected);
}
