 ...
 *
 * @generated SignedSource<<14e9aa102bc9a5d667d4e5f36b52d6f9>>
 */
...
async fn updatable_fragment_spread_abstract_in_concrete() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_abstract_in_concrete.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_abstract_in_concrete.expected"
    );
...
async fn updatable_fragment_spread_abstract_in_different_non_extending_abstract_invalid() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_abstract_in_different_non_extending_abstract.invalid.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_abstract_in_different_non_extending_abstract.invalid.expected"
    );
...
async fn updatable_fragment_spread_abstract_in_same_abstract() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_abstract_in_same_abstract.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_abstract_in_same_abstract.expected"
    );
...
async fn updatable_fragment_spread_concrete_in_different_concrete_invalid() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_concrete_in_different_concrete.invalid.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_concrete_in_different_concrete.invalid.expected"
    );
...
async fn updatable_fragment_spread_concrete_in_matching_abstract_invalid() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_concrete_in_matching_abstract.invalid.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_concrete_in_matching_abstract.invalid.expected"
    );
...
async fn updatable_fragment_spread_concrete_in_non_matching_abstract_invalid() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_concrete_in_non_matching_abstract.invalid.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_concrete_in_non_matching_abstract.invalid.expected"
    );
...
async fn updatable_fragment_spread_concrete_in_same_concrete() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_concrete_in_same_concrete.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_concrete_in_same_concrete.expected"
    );
...
async fn updatable_fragment_spread_in_condition_invalid() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_condition.invalid.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_condition.invalid.expected"
    );
...
async fn updatable_fragment_spread_in_inline_fragment() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "updatable_fragment_spread_in_inline_fragment.graphql",
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment.expected",
        input,
        expected,
    )
...
async fn updatable_fragment_spread_in_inline_fragment_other_selections_abstract_type_condition_invalid()
 {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_abstract_type_condition.invalid.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_abstract_type_condition.invalid.expected"
    );
...
async fn updatable_fragment_spread_in_inline_fragment_other_selections_no_typename_invalid() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_no_typename.invalid.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_no_typename.invalid.expected"
    );
...
async fn updatable_fragment_spread_in_inline_fragment_other_selections_redundant_type_condition_invalid()
 {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_redundant_type_condition.invalid.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_redundant_type_condition.invalid.expected"
    );
...
{
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_typename_with_alias.invalid.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_typename_with_alias.invalid.expected"
    );
...
async fn updatable_fragment_spread_in_inline_fragment_other_selections_typename_with_condition_invalid()
 {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_typename_with_condition.invalid.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_typename_with_condition.invalid.expected"
    );
...
async fn updatable_fragment_spread_in_inline_fragment_other_selections_typename_with_directives_invalid()
 {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_typename_with_directives.invalid.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_typename_with_directives.invalid.expected"
    );
...
async fn updatable_fragment_spread_in_inline_fragment_other_selections_with_fragment_spread_directives()
 {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_with_fragment_spread_directives.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_with_fragment_spread_directives.expected"
    );
...
async fn updatable_fragment_spread_in_inline_fragment_other_selections_wrong_type_invalid_1() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_wrong_type.invalid_1.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_wrong_type.invalid_1.expected"
    );
...
async fn updatable_fragment_spread_in_inline_fragment_other_selections_wrong_type_invalid_2() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_wrong_type.invalid_2.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_wrong_type.invalid_2.expected"
    );
...
async fn updatable_fragment_spread_in_inline_fragment_other_selections_wrong_type_invalid_3() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_wrong_type.invalid_3.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_wrong_type.invalid_3.expected"
    );
...
async fn updatable_fragment_spread_in_inline_fragment_other_selections_wrong_type_invalid_4() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_wrong_type.invalid_4.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_other_selections_wrong_type.invalid_4.expected"
    );
...
async fn updatable_fragment_spread_in_inline_fragment_with_abstract_type_condition_invalid() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_with_abstract_type_condition.invalid.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_with_abstract_type_condition.invalid.expected"
    );
...
async fn updatable_fragment_spread_in_inline_fragment_without_typename_invalid() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_without_typename.invalid.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_in_inline_fragment_without_typename.invalid.expected"
    );
...
async fn updatable_fragment_spread_top_level() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_top_level.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_top_level.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "updatable_fragment_spread_top_level.graphql",
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_top_level.expected",
        input,
        expected,
    )
...
#[tokio::test]
async fn updatable_fragment_spread_top_level_same_type() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_top_level_same_type.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_top_level_same_type.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "updatable_fragment_spread_top_level_same_type.graphql",
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_top_level_same_type.expected",
        input,
        expected,
    )
...
#[tokio::test]
async fn updatable_fragment_spread_top_level_subtype() {
    let input = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_top_level_subtype.graphql"
    );
    let expected = include_str!(
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_top_level_subtype.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "updatable_fragment_spread_top_level_subtype.graphql",
        "updatable_fragment_spread/fixtures/updatable_fragment_spread_top_level_subtype.expected",
        input,
        expected,
    )
