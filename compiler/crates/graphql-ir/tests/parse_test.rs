...
async fn argument_with_default() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "argument_with_default.graphql",
        "parse/fixtures/argument_with_default.expected",
        input,
        expected,
    )
    .await;
...
async fn fragment_argument_type_mismatch_invalid() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "fragment-argument-type-mismatch.invalid.graphql",
        "parse/fixtures/fragment-argument-type-mismatch.invalid.expected",
        input,
        expected,
    )
    .await;
...
async fn fragment_with_literal_enum_arguments_into_enum_list_indirect_invalid() {
    let input = include_str!(
        "parse/fixtures/fragment-with-literal-enum-arguments-into-enum-list-indirect.invalid.graphql"
    );
    let expected = include_str!(
        "parse/fixtures/fragment-with-literal-enum-arguments-into-enum-list-indirect.invalid.expected"
    );
...
async fn inline_fragment_within_invalid_inline_fragment_grandparent_invalid() {
    ...
    let expected = include_str!(
        "parse/fixtures/inline-fragment-within-invalid-inline-fragment-grandparent.invalid.expected"
    );
...
async fn inline_fragment_within_linked_field_and_wrong_inline_fragment_invalid() {
    let input = include_str!(
        "parse/fixtures/inline-fragment-within-linked-field-and-wrong-inline-fragment.invalid.graphql"
    );
    let expected = include_str!(
        "parse/fixtures/inline-fragment-within-linked-field-and-wrong-inline-fragment.invalid.expected"
    );
...
async fn input_object_multiple_invalid_fields() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "input_object_multiple_invalid_fields.graphql",
        "parse/fixtures/input_object_multiple_invalid_fields.expected",
        input,
        expected,
    )
    .await;
...
async fn multiple_field_argument_wrong_type_invalid() {
    ...
    let expected =
        include_str!("parse/fixtures/multiple_field_argument_wrong_type.invalid.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "multiple_field_argument_wrong_type.invalid.graphql",
        "parse/fixtures/multiple_field_argument_wrong_type.invalid.expected",
        input,
        expected,
    )
    .await;
...
async fn multiple_invalid_arguments_in_list() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "multiple_invalid_arguments_in_list.graphql",
        "parse/fixtures/multiple_invalid_arguments_in_list.expected",
        input,
        expected,
    )
    .await;
...
async fn variable_with_default() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "variable_with_default.graphql",
        "parse/fixtures/variable_with_default.expected",
        input,
        expected,
    )
    .await;
