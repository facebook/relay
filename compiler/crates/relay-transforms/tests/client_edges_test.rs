...
async fn client_edge_to_mixed_interface() {
    ...
    test_fixture(transform_fixture, file!(), "client-edge-to-mixed-interface.graphql", "client_edges/fixtures/client-edge-to-mixed-interface.expected", input, expected).await;
}
