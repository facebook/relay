...
async fn aliases_in_different_aliased_inline_fragments_dont_conflitc() {
    let input = include_str!(
        "validate_fragment_alias_conflict/fixtures/aliases_in_different_aliased_inline_fragments_dont_conflitc.graphql"
    );
    let expected = include_str!(
        "validate_fragment_alias_conflict/fixtures/aliases_in_different_aliased_inline_fragments_dont_conflitc.expected"
    );
...
async fn default_inline_fragment_alias_conflicts_with_field() {
    let input = include_str!(
        "validate_fragment_alias_conflict/fixtures/default_inline_fragment_alias_conflicts_with_field.graphql"
    );
    let expected = include_str!(
        "validate_fragment_alias_conflict/fixtures/default_inline_fragment_alias_conflicts_with_field.expected"
    );
...
async fn default_named_fragment_alias_conflicts_with_field() {
    let input = include_str!(
        "validate_fragment_alias_conflict/fixtures/default_named_fragment_alias_conflicts_with_field.graphql"
    );
    let expected = include_str!(
        "validate_fragment_alias_conflict/fixtures/default_named_fragment_alias_conflicts_with_field.expected"
    );
...
async fn fragment_alias_name_conflicts_with_field() {
    let input = include_str!(
        "validate_fragment_alias_conflict/fixtures/fragment_alias_name_conflicts_with_field.graphql"
    );
    let expected = include_str!(
        "validate_fragment_alias_conflict/fixtures/fragment_alias_name_conflicts_with_field.expected"
    );
...
async fn fragment_alias_name_conflicts_with_field_in_inline_fragment() {
    let input = include_str!(
        "validate_fragment_alias_conflict/fixtures/fragment_alias_name_conflicts_with_field_in_inline_fragment.graphql"
    );
    let expected = include_str!(
        "validate_fragment_alias_conflict/fixtures/fragment_alias_name_conflicts_with_field_in_inline_fragment.expected"
    );
...
async fn fragment_alias_name_conflicts_with_other_fragment_alias() {
    let input = include_str!(
        "validate_fragment_alias_conflict/fixtures/fragment_alias_name_conflicts_with_other_fragment_alias.graphql"
    );
    let expected = include_str!(
        "validate_fragment_alias_conflict/fixtures/fragment_alias_name_conflicts_with_other_fragment_alias.expected"
    );
