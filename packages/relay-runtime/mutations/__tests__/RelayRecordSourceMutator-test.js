...
describe('RelayRecordSourceMutator', () => {
  ...
  describe('unstable_getRawRecordWithChanges', () => {
    test('returns newly created records', () => {
    ...
    test('returns newly created records that are deleted in the base', () => {
    ...
    test('returns existing (unmodified) records', () => {
      const record = mutator.unstable_getRawRecordWithChanges('nyc');
      expect(record).toEqual({
        [ID_KEY]: 'nyc',
        [TYPENAME_KEY]: 'Page',
    ...
    test('returns null for already deleted records', () => {
      const record = mutator.unstable_getRawRecordWithChanges('deleted');
      expect(record).toEqual(null);
    });

    test('returns null for newly deleted records', () => {
      mutator.delete('mpk');
  ...
  describe('copyFields()', () => {
    test('throws if the source does not exist', () => {
    ...
    test('copies fields between existing records', () => {
    ...
    test('copies fields from an existing record to a created record', () => {
    ...
    test('copies fields from a created record to an existing record', () => {
      mutator.create('seattle', 'Page');
    ...
    test('copies new fields and create sentinel', () => {
    ...
    test('copies fields from a modified record to an existing record', () => {
  ...
  describe('copyFieldsFromRecord()', () => {
    test('throws if the sink does not exist', () => {
    ...
    test('copies fields to existing records', () => {
    ...
    test('copies new fields to existing records', () => {
      const sourceRecord = {
        [ID_KEY]: 'sf',
        [TYPENAME_KEY]: 'Page',
        state: 'California',
    ...
    test('copies fields from to a created record', () => {
      const sourceRecord = initialData.sf;
      mutator.create('seattle', 'Page');
  ...
  describe('create()', () => {
    test('throws if the record already exists', () => {
    ...
    test('throws if the record was previously created', () => {
    ...
    test('creates previously deleted records', () => {
    ...
    test('creates newly deleted records', () => {
    ...
    test('creates an "unpublish" backup record', () => {
      mutator.create('842472', 'User');
      expect(sinkSource.has('842472')).toBe(true);
      expect(baseData).toEqual(initialData);
      expect(sinkSource.toJSON()).toEqual({
  ...
  describe('delete()', () => {
    test('marks the record as deleted', () => {
      mutator.delete('4');
      expect(mutator.getStatus('4')).toBe(NONEXISTENT);
    });

    test('marks the record as deleted in the sink source', () => {
      mutator.delete('4');
      expect(sinkSource.get('4')).toBe(null);
    });

    test('does not modify the base source', () => {
  ...
  describe('getStatus()', () => {
    test('returns the status of an unmutated record', () => {
      expect(mutator.getStatus('4')).toBe(EXISTENT);
    });

    test('returns the status of a unknown record', () => {
      expect(mutator.getStatus('rms')).toBe(UNKNOWN);
    });

    test('returns the status of a non-existent record', () => {
      expect(mutator.getStatus('deleted')).toBe(NONEXISTENT);
    });

    test('returns the updated status of a mutated record', () => {
      mutator.delete('4');
      expect(mutator.getStatus('4')).toBe(NONEXISTENT);
    });
  });
  ...
  describe('getType()', () => {
    test('returns the type of an unmutated record', () => {
    ...
    test('returns the updated type of a mutated record', () => {
      mutator.delete('4');
  ...
  describe('getValue()', () => {
    test('returns the value if set', () => {
      expect(mutator.getValue('4', 'name')).toBe('Mark');
    });

    test('returns null if the record is deleted', () => {
      mutator.delete('4');
      expect(mutator.getValue('4', 'name')).toBe(null);
    });

    test('returns undefined for unfetched fields', () => {
      expect(mutator.getValue('4', 'unfetched')).toBe(undefined);
    });
  });

  describe('setValue()', () => {
    test('mutates a field on a record', () => {
      expect(mutator.getValue('4', 'name')).toBe('Mark');
    ...
    test('mutates multiple fields on a record', () => {
      mutator.setValue('4', 'name', 'Marcus');
    ...
    test('mutates fields on multiple records', () => {
      mutator.setValue('4', 'name', 'Marcus');
    ...
    test('mutates the same field multiple times', () => {
      mutator.setValue('4', 'name', 'Marcus');
    ...
    test('round-trips a field back to its original value', () => {
      const mark = baseSource.get('4');
      mutator.setValue('4', 'name', 'Marcus');
  ...
  describe('setLinkedRecordID()', () => {
    test('sets a linked record ID on a record', () => {
      expect(mutator.getLinkedRecordID('4', 'hometown')).toBe('mpk');
    ...
    test('sets multiple linked record IDs on a record', () => {
      mutator.setLinkedRecordID('4', 'hometown', 'beast');
    ...
    test('sets linked record IDs on multiple records', () => {
      mutator.setLinkedRecordID('4', 'hometown', 'beast');
    ...
    test('mutates the same link multiple times', () => {
      mutator.setLinkedRecordID('4', 'hometown', 'beast');
    ...
    test('round-trips a link back to its original value', () => {
      const mark = baseSource.get('4');
      mutator.setLinkedRecordID('4', 'hometown', 'sf');
  ...
  describe('setLinkedRecordIDs()', () => {
    test('sets a list of linked record IDs on a record', () => {
      expect(mutator.getLinkedRecordIDs('4', 'administeredPages')).toEqual([
        'beast',
      ]);
    ...
    test('sets multiple lists of linked record IDs on a record', () => {
      mutator.setLinkedRecordIDs('4', 'administeredPages', ['mpk']);
    ...
    test('sets lists of linked record IDs on multiple records', () => {
      mutator.setLinkedRecordIDs('4', 'administeredPages', ['mpk']);
    ...
    test('mutates the same links multiple times', () => {
      mutator.setLinkedRecordIDs('4', 'administeredPages', ['mpk']);
    ...
    test('round-trips links back to their original values', () => {
      const mark = baseSource.get('4');
      mutator.setLinkedRecordIDs('4', 'administeredPages', ['mpk']);
  ...
  describe('combining operations', () => {
    test('combines the effect of multiple operations', () => {
      mutator.setValue('4', 'name', 'Marcus');
