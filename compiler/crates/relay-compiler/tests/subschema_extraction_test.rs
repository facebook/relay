...
async fn inlined_nested_input() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "inlined_nested_input.input",
        "subschema_extraction/fixtures/inlined_nested_input.expected",
        input,
        expected,
    )
    .await;
...
async fn missing_full_schema() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "missing_full_schema.input",
        "subschema_extraction/fixtures/missing_full_schema.expected",
        input,
        expected,
    )
    .await;
...
async fn multiple_operations() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "multiple_operations.input",
        "subschema_extraction/fixtures/multiple_operations.expected",
        input,
        expected,
    )
    .await;
...
async fn mutation_with_input_types() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "mutation_with_input_types.input",
        "subschema_extraction/fixtures/mutation_with_input_types.expected",
        input,
        expected,
    )
    .await;
...
async fn simple_extraction() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "simple_extraction.input",
        "subschema_extraction/fixtures/simple_extraction.expected",
        input,
        expected,
    )
    .await;
...
async fn subscription_only() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "subscription_only.input",
        "subschema_extraction/fixtures/subscription_only.expected",
        input,
        expected,
    )
    .await;
...
async fn unknown_field_error() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "unknown_field_error.input",
        "subschema_extraction/fixtures/unknown_field_error.expected",
        input,
        expected,
    )
    .await;
...
async fn with_client_extensions() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "with_client_extensions.input",
        "subschema_extraction/fixtures/with_client_extensions.expected",
        input,
        expected,
    )
    .await;
