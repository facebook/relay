...
async fn find_subtype() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "find_subtype.graphql",
        "find_field_usages/fixtures/find_subtype.expected",
        input,
        expected,
    )
    .await;
...
async fn find_supertype() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "find_supertype.graphql",
        "find_field_usages/fixtures/find_supertype.expected",
        input,
        expected,
    )
    .await;
...
async fn fragment_field() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "fragment_field.graphql",
        "find_field_usages/fixtures/fragment_field.expected",
        input,
        expected,
    )
    .await;
...
async fn fragment_field_nomatch() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "fragment_field.nomatch.graphql",
        "find_field_usages/fixtures/fragment_field.nomatch.expected",
        input,
        expected,
    )
    .await;
...
async fn inline_fragment() {
    ...
    test_fixture(
        ...
        "find_field_usages/fixtures/inline_fragment.expected",
        input,
        expected,
    )
    .await;
...
async fn inline_fragment_also_matches_outer_type() {
    let input =
        include_str!("find_field_usages/fixtures/inline_fragment_also_matches_outer_type.graphql");
    let expected =
        include_str!("find_field_usages/fixtures/inline_fragment_also_matches_outer_type.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "inline_fragment_also_matches_outer_type.graphql",
        "find_field_usages/fixtures/inline_fragment_also_matches_outer_type.expected",
        input,
        expected,
    )
    .await;
...
async fn linked_field() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "linked_field.graphql",
        "find_field_usages/fixtures/linked_field.expected",
        input,
        expected,
    )
    .await;
...
async fn linked_field_nomatch() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "linked_field.nomatch.graphql",
        "find_field_usages/fixtures/linked_field.nomatch.expected",
        input,
        expected,
    )
    .await;
...
async fn multiple_matches() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "multiple_matches.graphql",
        "find_field_usages/fixtures/multiple_matches.expected",
        input,
        expected,
    )
    .await;
...
async fn query_field() {
    ...
    test_fixture(
        ...
        file!(),
        "query_field.graphql",
        "find_field_usages/fixtures/query_field.expected",
        input,
        expected,
    )
    .await;
