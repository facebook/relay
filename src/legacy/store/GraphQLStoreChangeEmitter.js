...
/**
 * Asynchronous change emitter for nodes stored in the Relay cache. Callers
 * include:
 * - `RelayStoreData`: broadcasts status changes after writing query and
 *   mutation payloads into the store.
 * - `GraphQLStoreQueryResolver`: subscribes to updates for any nodes that are
 *   part of an active query result set.
 *
 * @internal
 */
