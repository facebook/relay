...
var RelayTransformError = _require2.RelayTransformError;
          ...
          TaggedTemplateExpression: function TaggedTemplateExpression(path, state) {
            ...
            try {
              ...
              if (error instanceof RelayTransformError) {
                ...
                if (relative_loc) {
                  warning(['Within RelayQLDocument ' + filename + ':' + sourceLine, '> ', '> line ' + relative_loc.line, '> ' + relative_loc.source, '> ' + ' '.repeat(relative_loc.column - 1) + '^^^', 'Error: ' + error.message, 'Stack: ' + error.stack].join('\n'));
                }
              } else {
