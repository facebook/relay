...
async fn aliased_inline_fragment_spread_without_type_condition_fragment_root() {
    let input = include_str!(
        "generate_flow/fixtures/aliased-inline-fragment-spread-without-type-condition-fragment-root.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/aliased-inline-fragment-spread-without-type-condition-fragment-root.expected"
    );
...
async fn aliased_inline_fragment_spread_without_type_condition_linked_field() {
    let input = include_str!(
        "generate_flow/fixtures/aliased-inline-fragment-spread-without-type-condition-linked-field.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/aliased-inline-fragment-spread-without-type-condition-linked-field.expected"
    );
...
async fn aliased_inline_fragment_spread_without_type_condition_query_root() {
    let input = include_str!(
        "generate_flow/fixtures/aliased-inline-fragment-spread-without-type-condition-query-root.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/aliased-inline-fragment-spread-without-type-condition-query-root.expected"
    );
...
async fn catch_no_arg_nested() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "catch-no-arg-nested.graphql",
        "generate_flow/fixtures/catch-no-arg-nested.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_no_arg_nested_custom_error_type() {
    let input =
        include_str!("generate_flow/fixtures/catch-no-arg-nested-custom-error-type.graphql");
    let expected =
        include_str!("generate_flow/fixtures/catch-no-arg-nested-custom-error-type.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "catch-no-arg-nested-custom-error-type.graphql",
        "generate_flow/fixtures/catch-no-arg-nested-custom-error-type.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_no_arg_nested_linked() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "catch-no-arg-nested-linked.graphql",
        "generate_flow/fixtures/catch-no-arg-nested-linked.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_no_arg_nested_raw() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "catch-no-arg-nested-raw.graphql",
        "generate_flow/fixtures/catch-no-arg-nested-raw.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_no_arg_nested_raw_fragments() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/catch-no-arg-nested-raw-fragments.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "catch-no-arg-nested-raw-fragments.graphql",
        "generate_flow/fixtures/catch-no-arg-nested-raw-fragments.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_no_arg_nested_raw_fragments_catch_in_fragment() {
    let input = include_str!(
        "generate_flow/fixtures/catch-no-arg-nested-raw-fragments-catch-in-fragment.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/catch-no-arg-nested-raw-fragments-catch-in-fragment.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "catch-no-arg-nested-raw-fragments-catch-in-fragment.graphql",
        "generate_flow/fixtures/catch-no-arg-nested-raw-fragments-catch-in-fragment.expected",
        input,
        expected,
    )
...
async fn catch_no_arg_nested_raw_multiple_queries_and_fields() {
    let input = include_str!(
        "generate_flow/fixtures/catch-no-arg-nested-raw-multiple-queries-and-fields.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/catch-no-arg-nested-raw-multiple-queries-and-fields.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "catch-no-arg-nested-raw-multiple-queries-and-fields.graphql",
        "generate_flow/fixtures/catch-no-arg-nested-raw-multiple-queries-and-fields.expected",
        input,
        expected,
    )
...
async fn catch_on_aliased_inline_fragment() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "catch-on-aliased-inline-fragment.graphql",
        "generate_flow/fixtures/catch-on-aliased-inline-fragment.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_on_mutation() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "catch-on-mutation.graphql",
        "generate_flow/fixtures/catch-on-mutation.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_on_root() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "catch-on-root.graphql",
        "generate_flow/fixtures/catch-on-root.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_semantic_non_null_with_catch_no_arg() {
    let input =
        include_str!("generate_flow/fixtures/catch-semantic-non-null-with-catch-no-arg.graphql");
    let expected =
        include_str!("generate_flow/fixtures/catch-semantic-non-null-with-catch-no-arg.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "catch-semantic-non-null-with-catch-no-arg.graphql",
        "generate_flow/fixtures/catch-semantic-non-null-with-catch-no-arg.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_semantic_non_null_with_catch_to_null() {
    let input =
        include_str!("generate_flow/fixtures/catch-semantic-non-null-with-catch-to-null.graphql");
    let expected =
        include_str!("generate_flow/fixtures/catch-semantic-non-null-with-catch-to-null.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "catch-semantic-non-null-with-catch-to-null.graphql",
        "generate_flow/fixtures/catch-semantic-non-null-with-catch-to-null.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_to_null_nested() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "catch-to-null-nested.graphql",
        "generate_flow/fixtures/catch-to-null-nested.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_to_null_on_aliased_inline_fragment() {
    let input =
        include_str!("generate_flow/fixtures/catch-to-null-on-aliased-inline-fragment.graphql");
    let expected =
        include_str!("generate_flow/fixtures/catch-to-null-on-aliased-inline-fragment.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "catch-to-null-on-aliased-inline-fragment.graphql",
        "generate_flow/fixtures/catch-to-null-on-aliased-inline-fragment.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_to_null_on_fragment() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "catch-to-null-on-fragment.graphql",
        "generate_flow/fixtures/catch-to-null-on-fragment.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_to_null_on_query() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "catch-to-null-on-query.graphql",
        "generate_flow/fixtures/catch-to-null-on-query.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_to_result_nested() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "catch-to-result-nested.graphql",
        "generate_flow/fixtures/catch-to-result-nested.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_to_result_on_aliased_inline_fragment() {
    let input =
        include_str!("generate_flow/fixtures/catch-to-result-on-aliased-inline-fragment.graphql");
    let expected =
        include_str!("generate_flow/fixtures/catch-to-result-on-aliased-inline-fragment.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "catch-to-result-on-aliased-inline-fragment.graphql",
        "generate_flow/fixtures/catch-to-result-on-aliased-inline-fragment.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_to_result_on_fragment() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "catch-to-result-on-fragment.graphql",
        "generate_flow/fixtures/catch-to-result-on-fragment.expected",
        input,
        expected,
    )
    .await;
...
async fn catch_to_result_on_query() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "catch-to-result-on-query.graphql",
        "generate_flow/fixtures/catch-to-result-on-query.expected",
        input,
        expected,
    )
    .await;
...
async fn default_input() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "default-input.graphql",
        "generate_flow/fixtures/default-input.expected",
        input,
        expected,
    )
    .await;
...
async fn mixed_conditonal_raw_response() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "mixed-conditonal-raw-response.graphql",
        "generate_flow/fixtures/mixed-conditonal-raw-response.expected",
        input,
        expected,
    )
    .await;
...
async fn mutation_with_one_of() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "mutation-with-one-of.graphql",
        "generate_flow/fixtures/mutation-with-one-of.expected",
        input,
        expected,
    )
    .await;
...
async fn query_with_raw_response_abstract_in_catch_all() {
    let input = include_str!(
        "generate_flow/fixtures/query-with-raw-response-abstract-in-catch-all.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/query-with-raw-response-abstract-in-catch-all.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "query-with-raw-response-abstract-in-catch-all.graphql",
        "generate_flow/fixtures/query-with-raw-response-abstract-in-catch-all.expected",
        input,
        expected,
    )
...
async fn query_with_raw_response_concrete_and_interface_spreads() {
    let input = include_str!(
        "generate_flow/fixtures/query-with-raw-response-concrete-and-interface-spreads.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/query-with-raw-response-concrete-and-interface-spreads.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "query-with-raw-response-concrete-and-interface-spreads.graphql",
        "generate_flow/fixtures/query-with-raw-response-concrete-and-interface-spreads.expected",
        input,
        expected,
    )
...
async fn query_with_raw_response_interface() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/query-with-raw-response-interface.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "query-with-raw-response-interface.graphql",
        "generate_flow/fixtures/query-with-raw-response-interface.expected",
        input,
        expected,
    )
    .await;
...
async fn query_with_raw_response_interface_inline_fragment_on_interface() {
    let input = include_str!(
        "generate_flow/fixtures/query-with-raw-response-interface-inline-fragment-on-interface.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/query-with-raw-response-interface-inline-fragment-on-interface.expected"
    );
...
async fn query_with_raw_response_linked_field_in_abstract_spread() {
    let input = include_str!(
        "generate_flow/fixtures/query-with-raw-response-linked-field-in-abstract-spread.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/query-with-raw-response-linked-field-in-abstract-spread.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "query-with-raw-response-linked-field-in-abstract-spread.graphql",
        "generate_flow/fixtures/query-with-raw-response-linked-field-in-abstract-spread.expected",
        input,
        expected,
    )
...
async fn query_with_raw_response_mixed_abstract_and_concrete_spreads() {
    let input = include_str!(
        "generate_flow/fixtures/query-with-raw-response-mixed-abstract-and-concrete-spreads.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/query-with-raw-response-mixed-abstract-and-concrete-spreads.expected"
    );
...
async fn query_with_raw_response_nested_abstract_inline_fragments() {
    let input = include_str!(
        "generate_flow/fixtures/query-with-raw-response-nested-abstract-inline-fragments.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/query-with-raw-response-nested-abstract-inline-fragments.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "query-with-raw-response-nested-abstract-inline-fragments.graphql",
        "generate_flow/fixtures/query-with-raw-response-nested-abstract-inline-fragments.expected",
        input,
        expected,
    )
...
async fn query_with_raw_response_nested_different_abstract_inline_fragments() {
    let input = include_str!(
        "generate_flow/fixtures/query-with-raw-response-nested-different-abstract-inline-fragments.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/query-with-raw-response-nested-different-abstract-inline-fragments.expected"
    );
...
async fn query_with_raw_response_object_inline_fragment_on_interface() {
    let input = include_str!(
        "generate_flow/fixtures/query-with-raw-response-object-inline-fragment-on-interface.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/query-with-raw-response-object-inline-fragment-on-interface.expected"
    );
...
async fn query_with_raw_response_union() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "query-with-raw-response-union.graphql",
        "generate_flow/fixtures/query-with-raw-response-union.expected",
        input,
        expected,
    )
    .await;
...
async fn query_with_raw_response_union_and_interface_spread_all_implement() {
    let input = include_str!(
        "generate_flow/fixtures/query-with-raw-response-union-and-interface-spread-all-implement.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/query-with-raw-response-union-and-interface-spread-all-implement.expected"
    );
...
async fn query_with_raw_response_union_and_interface_spread_with_non_null_field() {
    let input = include_str!(
        "generate_flow/fixtures/query-with-raw-response-union-and-interface-spread-with-non-null-field.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/query-with-raw-response-union-and-interface-spread-with-non-null-field.expected"
    );
...
async fn relay_resolver_plural_required_client_edge_with_required_edge() {
    let input = include_str!(
        "generate_flow/fixtures/relay-resolver-plural-required-client-edge-with-required-edge.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/relay-resolver-plural-required-client-edge-with-required-edge.expected"
    );
...
async fn relay_resolver_with_output_type_relay_resolver_value_plural() {
    let input = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-relay-resolver-value-plural.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-relay-resolver-value-plural.expected"
    );
...
async fn relay_resolver_with_output_type_relay_resolver_value_required() {
    let input = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-relay-resolver-value-required.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-relay-resolver-value-required.expected"
    );
...
async fn required_bubbles_to_non_null_item_in_non_null_plural_linked_field() {
    let input = include_str!(
        "generate_flow/fixtures/required-bubbles-to-non-null-item-in-non-null-plural-linked-field.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/required-bubbles-to-non-null-item-in-non-null-plural-linked-field.expected"
    );
...
async fn required_bubbles_to_non_null_linked_field_through_inline_fragment() {
    let input = include_str!(
        "generate_flow/fixtures/required-bubbles-to-non-null-linked-field-through-inline-fragment.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/required-bubbles-to-non-null-linked-field-through-inline-fragment.expected"
    );
...
async fn required_chain_bubbles_to_non_null_linked_field_through_inline_fragment() {
    let input = include_str!(
        "generate_flow/fixtures/required-chain-bubbles-to-non-null-linked-field-through-inline-fragment.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/required-chain-bubbles-to-non-null-linked-field-through-inline-fragment.expected"
    );
...
async fn required_conditional() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "required-conditional.graphql",
        "generate_flow/fixtures/required-conditional.expected",
        input,
        expected,
    )
    .await;
...
async fn resolver_on_interface_of_all_strong_model_type() {
    let input = include_str!(
        "generate_flow/fixtures/resolver-on-interface-of-all-strong-model-type.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/resolver-on-interface-of-all-strong-model-type.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "resolver-on-interface-of-all-strong-model-type.graphql",
        "generate_flow/fixtures/resolver-on-interface-of-all-strong-model-type.expected",
        input,
        expected,
    )
...
async fn resolver_on_interface_of_all_strong_model_type_with_extension() {
    let input = include_str!(
        "generate_flow/fixtures/resolver-on-interface-of-all-strong-model-type-with-extension.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/resolver-on-interface-of-all-strong-model-type-with-extension.expected"
    );
...
async fn resolver_on_interface_of_all_strong_model_type_with_root_fragment() {
    let input = include_str!(
        "generate_flow/fixtures/resolver-on-interface-of-all-strong-model-type-with-root-fragment.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/resolver-on-interface-of-all-strong-model-type-with-root-fragment.expected"
    );
...
async fn resolver_on_interface_of_all_weak_model_type() {
    let input =
        include_str!("generate_flow/fixtures/resolver-on-interface-of-all-weak-model-type.graphql");
    let expected = include_str!(
        "generate_flow/fixtures/resolver-on-interface-of-all-weak-model-type.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "resolver-on-interface-of-all-weak-model-type.graphql",
        "generate_flow/fixtures/resolver-on-interface-of-all-weak-model-type.expected",
        input,
        expected,
    )
...
async fn semantic_non_null_in_raw_response() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/semantic_non_null_in_raw_response.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_in_raw_response.graphql",
        "generate_flow/fixtures/semantic_non_null_in_raw_response.expected",
        input,
        expected,
    )
    .await;
...
async fn semantic_non_null_items_in_matrix() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/semantic_non_null_items_in_matrix.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_items_in_matrix.graphql",
        "generate_flow/fixtures/semantic_non_null_items_in_matrix.expected",
        input,
        expected,
    )
    .await;
...
async fn semantic_non_null_liked_field_resolver() {
    let input =
        include_str!("generate_flow/fixtures/semantic_non_null_liked_field_resolver.graphql");
    let expected =
        include_str!("generate_flow/fixtures/semantic_non_null_liked_field_resolver.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_liked_field_resolver.graphql",
        "generate_flow/fixtures/semantic_non_null_liked_field_resolver.expected",
        input,
        expected,
    )
    .await;
...
async fn semantic_non_null_liked_field_weak_resolver() {
    let input =
        include_str!("generate_flow/fixtures/semantic_non_null_liked_field_weak_resolver.graphql");
    let expected =
        include_str!("generate_flow/fixtures/semantic_non_null_liked_field_weak_resolver.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_liked_field_weak_resolver.graphql",
        "generate_flow/fixtures/semantic_non_null_liked_field_weak_resolver.expected",
        input,
        expected,
    )
    .await;
...
async fn semantic_non_null_linked_field() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_linked_field.graphql",
        "generate_flow/fixtures/semantic_non_null_linked_field.expected",
        input,
        expected,
    )
    .await;
...
async fn semantic_non_null_list_and_list_item() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/semantic_non_null_list_and_list_item.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_list_and_list_item.graphql",
        "generate_flow/fixtures/semantic_non_null_list_and_list_item.expected",
        input,
        expected,
    )
    .await;
...
async fn semantic_non_null_list_item() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_list_item.graphql",
        "generate_flow/fixtures/semantic_non_null_list_item.expected",
        input,
        expected,
    )
    .await;
...
async fn semantic_non_null_scalar() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_scalar.graphql",
        "generate_flow/fixtures/semantic_non_null_scalar.expected",
        input,
        expected,
    )
    .await;
...
async fn semantic_non_null_scalar_feature_disabled() {
    let input =
        include_str!("generate_flow/fixtures/semantic_non_null_scalar_feature_disabled.graphql");
    let expected =
        include_str!("generate_flow/fixtures/semantic_non_null_scalar_feature_disabled.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_scalar_feature_disabled.graphql",
        "generate_flow/fixtures/semantic_non_null_scalar_feature_disabled.expected",
        input,
        expected,
    )
    .await;
...
async fn semantic_non_null_scalar_resolver() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/semantic_non_null_scalar_resolver.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_scalar_resolver.graphql",
        "generate_flow/fixtures/semantic_non_null_scalar_resolver.expected",
        input,
        expected,
    )
    .await;
...
async fn semantic_non_null_scalar_with_catch() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/semantic_non_null_scalar_with_catch.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_scalar_with_catch.graphql",
        "generate_flow/fixtures/semantic_non_null_scalar_with_catch.expected",
        input,
        expected,
    )
    .await;
...
async fn semantic_non_null_scalar_within_catch_fragment() {
    let input = include_str!(
        "generate_flow/fixtures/semantic_non_null_scalar_within_catch_fragment.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/semantic_non_null_scalar_within_catch_fragment.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_scalar_within_catch_fragment.graphql",
        "generate_flow/fixtures/semantic_non_null_scalar_within_catch_fragment.expected",
        input,
        expected,
    )
...
async fn semantic_non_null_scalar_within_catch_inline_fragment() {
    let input = include_str!(
        "generate_flow/fixtures/semantic_non_null_scalar_within_catch_inline_fragment.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/semantic_non_null_scalar_within_catch_inline_fragment.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_scalar_within_catch_inline_fragment.graphql",
        "generate_flow/fixtures/semantic_non_null_scalar_within_catch_inline_fragment.expected",
        input,
        expected,
    )
...
async fn semantic_non_null_scalar_within_catch_query() {
    let input =
        include_str!("generate_flow/fixtures/semantic_non_null_scalar_within_catch_query.graphql");
    let expected =
        include_str!("generate_flow/fixtures/semantic_non_null_scalar_within_catch_query.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_scalar_within_catch_query.graphql",
        "generate_flow/fixtures/semantic_non_null_scalar_within_catch_query.expected",
        input,
        expected,
    )
    .await;
...
async fn semantic_non_null_scalar_within_inline_fragment() {
    let input = include_str!(
        "generate_flow/fixtures/semantic_non_null_scalar_within_inline_fragment.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/semantic_non_null_scalar_within_inline_fragment.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_non_null_scalar_within_inline_fragment.graphql",
        "generate_flow/fixtures/semantic_non_null_scalar_within_inline_fragment.expected",
        input,
        expected,
    )
...
async fn semantic_null_required_throw_on_error() {
    let input =
        include_str!("generate_flow/fixtures/semantic_null_required_throw_on_error.graphql");
    let expected =
        include_str!("generate_flow/fixtures/semantic_null_required_throw_on_error.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "semantic_null_required_throw_on_error.graphql",
        "generate_flow/fixtures/semantic_null_required_throw_on_error.expected",
        input,
        expected,
    )
    .await;
