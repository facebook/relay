 ...
 * @oncall relay
 *
 * @generated SignedSource<<c733c40dafb91fbd238c7d71662885f1>>
 * @flow
...
export type RelayReaderResolverTest19Query$data = {|
  +me: ?{|
    +big_profile_picture: ?{|
      +uri: ?string,
    |},
    +profile_picture2: ?ReturnType<typeof userUserProfilePictureUriWithScaleAndDefaultValueResolverType>,
  |},
|};
