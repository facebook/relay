...
// OperationLoader: resolves the operationModuleProvider dynamic imports
// generated by the compiler for each @module branch's split normalization AST.
const operationLoader = {
  get(_reference: unknown) {
    return null;
  },
  load(reference: unknown) {
    if (typeof reference === "function") {
      return (reference as () => Promise<any>)().then(
        (m: any) => m.default,
      );
    }
