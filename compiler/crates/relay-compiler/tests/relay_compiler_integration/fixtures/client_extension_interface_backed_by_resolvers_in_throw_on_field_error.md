...
>*/);
```
```js title="__generated__/fooFragment.graphql.js"
/**
...
Project: default
  Type: Mapping
  - Source: ExecutableDefinition: fooFragment
    Path: __generated__/fooFragment.graphql.js
  - Source: ResolverHash: ResolverSourceHash("42dad5aeb9fb8a9a2369b309f041410f")
