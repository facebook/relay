...
async fn diamond_dependency() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "diamond-dependency.graphql",
        "query_stats/fixtures/diamond-dependency.expected",
        input,
        expected,
    )
    .await;
...
async fn direct_and_indirect() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "direct-and-indirect.graphql",
        "query_stats/fixtures/direct-and-indirect.expected",
        input,
        expected,
    )
    .await;
...
async fn direct_fragments_only() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "direct-fragments-only.graphql",
        "query_stats/fixtures/direct-fragments-only.expected",
        input,
        expected,
    )
    .await;
...
async fn mixed_operations() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "mixed-operations.graphql",
        "query_stats/fixtures/mixed-operations.expected",
        input,
        expected,
    )
    .await;
...
async fn multiple_operations() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "multiple-operations.graphql",
        "query_stats/fixtures/multiple-operations.expected",
        input,
        expected,
    )
    .await;
...
async fn nested_fragments() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "nested-fragments.graphql",
        "query_stats/fixtures/nested-fragments.expected",
        input,
        expected,
    )
    .await;
...
async fn no_fragments() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "no-fragments.graphql",
        "query_stats/fixtures/no-fragments.expected",
        input,
        expected,
    )
    .await;
