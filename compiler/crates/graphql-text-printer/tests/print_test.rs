...
async fn basic_arg_defs() {
    ...
    test_fixture(
        ...
        "print/fixtures/basic_arg_defs.expected",
        input,
        expected,
    )
    .await;
...
async fn basic_directives() {
    ...
    test_fixture(
        ...
        "print/fixtures/basic_directives.expected",
        input,
        expected,
    )
    .await;
...
async fn basic_fragment() {
    ...
    test_fixture(
        ...
        "print/fixtures/basic_fragment.expected",
        input,
        expected,
    )
    .await;
...
async fn basic_inline_fragments() {
    ...
    test_fixture(
        ...
        "print/fixtures/basic_inline_fragments.expected",
        input,
        expected,
    )
    .await;
...
async fn basic_list_object_values() {
    ...
    test_fixture(
        ...
        "print/fixtures/basic_list_object_values.expected",
        input,
        expected,
    )
    .await;
...
async fn basic_query() {
    ...
    test_fixture(
        ...
        file!(),
        "basic_query.graphql",
        "print/fixtures/basic_query.expected",
        input,
        expected,
    )
    .await;
...
async fn basic_var_defs() {
    ...
    test_fixture(
        ...
        "print/fixtures/basic_var_defs.expected",
        input,
        expected,
    )
    .await;
...
async fn conditions() {
    ...
    test_fixture(
        ...
        file!(),
        "conditions.graphql",
        "print/fixtures/conditions.expected",
        input,
        expected,
    )
    .await;
...
async fn empty_args() {
    ...
    test_fixture(
        ...
        file!(),
        "empty_args.graphql",
        "print/fixtures/empty_args.expected",
        input,
        expected,
    )
    .await;
...
async fn fragment_variables() {
    ...
    test_fixture(
        ...
        "print/fixtures/fragment_variables.expected",
        input,
        expected,
    )
    .await;
...
async fn kitchen_sink() {
    ...
    test_fixture(
        ...
        "print/fixtures/kitchen-sink.expected",
        input,
        expected,
    )
    .await;
...
async fn nested_conditions() {
    ...
    test_fixture(
        ...
        "print/fixtures/nested_conditions.expected",
        input,
        expected,
    )
    .await;
...
async fn single_value_array_of_objects() {
    ...
    test_fixture(
        ...
        "print/fixtures/single-value-array-of-objects.expected",
        input,
        expected,
    )
    .await;
...
async fn string_enum_arg_invalid() {
    ...
    test_fixture(
        ...
        "print/fixtures/string-enum-arg.invalid.expected",
        input,
        expected,
    )
    .await;
...
async fn string_enum_fragment_arg() {
    ...
    test_fixture(
        ...
        "print/fixtures/string-enum-fragment-arg.expected",
        input,
        expected,
    )
    .await;
...
async fn string_enum_fragment_arg_with_complex_input() {
    ...
    let expected =
        include_str!("print/fixtures/string-enum-fragment-arg-with-complex-input.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "string-enum-fragment-arg-with-complex-input.graphql",
        "print/fixtures/string-enum-fragment-arg-with-complex-input.expected",
        input,
        expected,
    )
    .await;
...
async fn unknown_enum_arg_invalid() {
    ...
    test_fixture(
        ...
        "print/fixtures/unknown-enum-arg.invalid.expected",
        input,
        expected,
    )
    .await;
