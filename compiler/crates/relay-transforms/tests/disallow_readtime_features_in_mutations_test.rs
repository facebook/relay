...
async fn fragment_with_required_spread_in_fragment() {
    let input = include_str!(
        "disallow_readtime_features_in_mutations/fixtures/fragment_with_required_spread_in_fragment.graphql"
    );
    let expected = include_str!(
        "disallow_readtime_features_in_mutations/fixtures/fragment_with_required_spread_in_fragment.expected"
    );
...
async fn mutation_with_linked_resolver_invalid() {
    let input = include_str!(
        "disallow_readtime_features_in_mutations/fixtures/mutation_with_linked_resolver.invalid.graphql"
    );
    let expected = include_str!(
        "disallow_readtime_features_in_mutations/fixtures/mutation_with_linked_resolver.invalid.expected"
    );
...
async fn mutation_with_required_field_in_inline_fragment_invalid() {
    let input = include_str!(
        "disallow_readtime_features_in_mutations/fixtures/mutation_with_required_field_in_inline_fragment.invalid.graphql"
    );
    let expected = include_str!(
        "disallow_readtime_features_in_mutations/fixtures/mutation_with_required_field_in_inline_fragment.invalid.expected"
    );
...
async fn mutation_with_required_field_invalid() {
    let input = include_str!(
        "disallow_readtime_features_in_mutations/fixtures/mutation_with_required_field.invalid.graphql"
    );
    let expected = include_str!(
        "disallow_readtime_features_in_mutations/fixtures/mutation_with_required_field.invalid.expected"
    );
...
async fn mutation_with_required_log_or_none_field() {
    let input = include_str!(
        "disallow_readtime_features_in_mutations/fixtures/mutation_with_required_log_or_none_field.graphql"
    );
    let expected = include_str!(
        "disallow_readtime_features_in_mutations/fixtures/mutation_with_required_log_or_none_field.expected"
    );
...
async fn mutation_with_scalar_resolver_invalid() {
    let input = include_str!(
        "disallow_readtime_features_in_mutations/fixtures/mutation_with_scalar_resolver.invalid.graphql"
    );
    let expected = include_str!(
        "disallow_readtime_features_in_mutations/fixtures/mutation_with_scalar_resolver.invalid.expected"
    );
...
async fn query_with_required_field() {
    let input = include_str!(
        "disallow_readtime_features_in_mutations/fixtures/query_with_required_field.graphql"
    );
    let expected = include_str!(
        "disallow_readtime_features_in_mutations/fixtures/query_with_required_field.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
