 ...
 * @oncall relay
 *
 * @generated SignedSource<<1a703dc1b73b1f292d6eba9b50fc3024>>
 * @flow
...
export type RelayResolverMixedInterfaceTestVehicleBicycleQuery$variables = {
  isCar: boolean,
};
export type RelayResolverMixedInterfaceTestVehicleBicycleQuery$data = {
  readonly vehicle: ?{
    readonly $fragmentSpreads: RelayResolverMixedInterfaceTestWheelsFragment$fragmentType,
  },
};
export type RelayResolverMixedInterfaceTestVehicleBicycleQuery = {
  response: RelayResolverMixedInterfaceTestVehicleBicycleQuery$data,
  variables: RelayResolverMixedInterfaceTestVehicleBicycleQuery$variables,
};
*/
...
return {
  "fragment": {
    ...
    "name": "RelayResolverMixedInterfaceTestVehicleBicycleQuery",
    "selections": [
      {
        ...
        "serverObjectOperations": {
          "Bicycle": require('./ClientEdgeQuery_RelayResolverMixedInterfaceTestVehicleBicycleQuery_vehicle.graphql')
        },
        "backingField": {
          "alias": null,
          "args": (v1/*:: as any*/),
  ...
  "params": {
    "cacheID": "abb39b3de7b9d8d500c6db82abf2bc57",
    "id": null,
    "metadata": {},
    "name": "RelayResolverMixedInterfaceTestVehicleBicycleQuery",
    "operationKind": "query",
...
module.exports = ((node/*:: as any*/)/*:: as ClientQuery<
  RelayResolverMixedInterfaceTestVehicleBicycleQuery$variables,
  RelayResolverMixedInterfaceTestVehicleBicycleQuery$data,
>*/);
