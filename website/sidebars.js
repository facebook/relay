  ...
  docs: [
    'home',
    {
      ...
      'API Reference': [
        ...
        {
          'Relay Resolvers': [
            'api-reference/relay-resolvers/introduction',
            'api-reference/relay-resolvers/defining-types',
            'api-reference/relay-resolvers/defining-fields',
            'api-reference/relay-resolvers/return-types',
            'api-reference/relay-resolvers/field-arguments',
            'api-reference/relay-resolvers/derived-fields',
            'api-reference/relay-resolvers/live-fields',
            'api-reference/relay-resolvers/suspense',
