...
async fn prod_query_invalid() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "prod_query.invalid.graphql",
        "relay_test_operation/fixtures/prod_query.invalid.expected",
        input,
        expected,
    )
    .await;
...
async fn prod_query_with_argument() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "prod_query_with_argument.graphql",
        "relay_test_operation/fixtures/prod_query_with_argument.expected",
        input,
        expected,
    )
    .await;
...
async fn prod_query_with_argument_invalid() {
    let input =
        include_str!("relay_test_operation/fixtures/prod_query_with_argument.invalid.graphql");
    let expected =
        include_str!("relay_test_operation/fixtures/prod_query_with_argument.invalid.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "prod_query_with_argument.invalid.graphql",
        "relay_test_operation/fixtures/prod_query_with_argument.invalid.expected",
        input,
        expected,
    )
    .await;
...
async fn test_client_fields_query() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "test_client_fields_query.graphql",
        "relay_test_operation/fixtures/test_client_fields_query.expected",
        input,
        expected,
    )
    .await;
...
async fn test_query_with_enums() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "test_query_with_enums.graphql",
        "relay_test_operation/fixtures/test_query_with_enums.expected",
        input,
        expected,
    )
    .await;
...
async fn test_simple_query() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "test_simple_query.graphql",
        "relay_test_operation/fixtures/test_simple_query.expected",
        input,
        expected,
    )
    .await;
