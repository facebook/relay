 ...
 * @oncall relay
 *
 * @generated SignedSource<<6b166adf54254a138e3d0989a898e5e5>>
 * @flow
...
(queryManyLiveTodosResolverType: () => LiveState<?$ReadOnlyArray<?tests_Query__many_live_todos$normalization>>);
import type { tests_Query__many_live_todos$normalization } from "./../../../relay-runtime/store/__tests__/resolvers/__generated__/tests_Query__many_live_todos$normalization.graphql";
    ...
    "selections": [
      {
        ...
        "backingField": {
          ...
          "normalizationInfo": {
            "concreteType": "Todo",
            "plural": true,
            "normalizationNode": require('./../../../relay-runtime/store/__tests__/resolvers/__generated__/tests_Query__many_live_todos$normalization.graphql')
          }
        },
        "linkedField": {
          "alias": null,
