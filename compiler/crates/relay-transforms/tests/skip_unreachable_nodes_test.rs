...
async fn empty_selection_skip_true() {
    ...
    let expected =
        include_str!("skip_unreachable_nodes/fixtures/empty-selection-skip-true.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "empty-selection-skip-true.graphql",
        "skip_unreachable_nodes/fixtures/empty-selection-skip-true.expected",
        input,
        expected,
    )
    .await;
...
async fn empty_selectoin_include_false() {
    let input =
        include_str!("skip_unreachable_nodes/fixtures/empty-selectoin-include-false.graphql");
    let expected =
        include_str!("skip_unreachable_nodes/fixtures/empty-selectoin-include-false.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "empty-selectoin-include-false.graphql",
        "skip_unreachable_nodes/fixtures/empty-selectoin-include-false.expected",
        input,
        expected,
    )
    .await;
...
async fn keeps_other_fields() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "keeps-other-fields.graphql",
        "skip_unreachable_nodes/fixtures/keeps-other-fields.expected",
        input,
        expected,
    )
    .await;
...
async fn removes_include_false() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "removes-include-false.graphql",
        "skip_unreachable_nodes/fixtures/removes-include-false.expected",
        input,
        expected,
    )
    .await;
...
async fn removes_recursively_empty_definitions() {
    let input = include_str!(
        "skip_unreachable_nodes/fixtures/removes-recursively-empty-definitions.graphql"
    );
    let expected = include_str!(
        "skip_unreachable_nodes/fixtures/removes-recursively-empty-definitions.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "removes-recursively-empty-definitions.graphql",
        "skip_unreachable_nodes/fixtures/removes-recursively-empty-definitions.expected",
        input,
        expected,
    )
...
async fn removes_skip_true() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "removes-skip-true.graphql",
        "skip_unreachable_nodes/fixtures/removes-skip-true.expected",
        input,
        expected,
    )
    .await;
...
async fn skipped_fragment() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "skipped-fragment.graphql",
        "skip_unreachable_nodes/fixtures/skipped-fragment.expected",
        input,
        expected,
    )
    .await;
