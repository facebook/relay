  ...
  describe('execute() a query with @stream', () => {
    ...
    it('process batched steaming responses with the mix of initial and incremental payloads', () => {
      ...
      if (enableBatchedStoreUpdates) {
        ...
        expect(firstSnapshot.isMissingData).toBe(false);
...
describe('with ENABLED_BATCHED_STORE_UPDATES set to true', () => {
  runTestsWithBatchedStoreUpdatesSetting(true);
});

describe('with ENABLED_BATCHED_STORE_UPDATES set to false', () => {
