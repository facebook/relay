...
async fn anonymous_inline_fragment_with_directives() {
    ...
    let expected =
        include_str!("flatten/fixtures/anonymous-inline-fragment-with-directives.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "anonymous-inline-fragment-with-directives.graphql",
        "flatten/fixtures/anonymous-inline-fragment-with-directives.expected",
        input,
        expected,
    )
    .await;
...
async fn flatten_multiple_conditions() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "flatten-multiple-conditions.graphql",
        "flatten/fixtures/flatten-multiple-conditions.expected",
        input,
        expected,
    )
    .await;
...
async fn flatten_same_conditions() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "flatten-same-conditions.graphql",
        "flatten/fixtures/flatten-same-conditions.expected",
        input,
        expected,
    )
    .await;
...
async fn flatten_transform() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "flatten-transform.graphql",
        "flatten/fixtures/flatten-transform.expected",
        input,
        expected,
    )
    .await;
...
async fn flattens_inline_inside_condition() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "flattens-inline-inside-condition.graphql",
        "flatten/fixtures/flattens-inline-inside-condition.expected",
        input,
        expected,
    )
    .await;
...
async fn flattens_inside_plural() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "flattens-inside-plural.graphql",
        "flatten/fixtures/flattens-inside-plural.expected",
        input,
        expected,
    )
    .await;
...
async fn flattens_matching_fragment_types() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "flattens-matching-fragment-types.graphql",
        "flatten/fixtures/flattens-matching-fragment-types.expected",
        input,
        expected,
    )
    .await;
...
async fn inline_fragment_with_directives() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "inline-fragment-with-directives.graphql",
        "flatten/fixtures/inline-fragment-with-directives.expected",
        input,
        expected,
    )
    .await;
...
async fn inline_fragment_with_directives_text() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "inline-fragment-with-directives-text.graphql",
        "flatten/fixtures/inline-fragment-with-directives-text.expected",
        input,
        expected,
    )
    .await;
...
async fn linked_handle_field() {
    ...
    test_fixture(
        ...
        "flatten/fixtures/linked-handle-field.expected",
        input,
        expected,
    )
    .await;
...
async fn match_field() {
    ...
    test_fixture(
        ...
        file!(),
        "match-field.graphql",
        "flatten/fixtures/match-field.expected",
        input,
        expected,
    )
    .await;
...
async fn match_field_overlap() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "match-field-overlap.graphql",
        "flatten/fixtures/match-field-overlap.expected",
        input,
        expected,
    )
    .await;
...
async fn scalar_handle_field() {
    ...
    test_fixture(
        ...
        "flatten/fixtures/scalar-handle-field.expected",
        input,
        expected,
    )
    .await;
