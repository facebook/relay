...
async fn basic_hoist() {
    ...
    test_fixture(
        ...
        file!(),
        "basic_hoist.graphql",
        "hoist_query_selections/fixtures/basic_hoist.expected",
        input,
        expected,
    )
    .await;
...
async fn fragment_hoist() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "fragment_hoist.graphql",
        "hoist_query_selections/fixtures/fragment_hoist.expected",
        input,
        expected,
    )
    .await;
...
async fn multiple_query_selections() {
    ...
    let expected =
        include_str!("hoist_query_selections/fixtures/multiple_query_selections.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "multiple_query_selections.graphql",
        "hoist_query_selections/fixtures/multiple_query_selections.expected",
        input,
        expected,
    )
    .await;
...
async fn conditional_hoist() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "conditional_hoist.graphql",
        "hoist_query_selections/fixtures/conditional_hoist.expected",
        input,
        expected,
    )
    .await;
...
async fn no_query_selections() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "no_query_selections.graphql",
        "hoist_query_selections/fixtures/no_query_selections.expected",
        input,
        expected,
    )
    .await;
...
async fn skip_on_query_field() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "skip_on_query_field.graphql",
        "hoist_query_selections/fixtures/skip_on_query_field.expected",
        input,
        expected,
    )
    .await;
...
async fn nested_conditions() {
    ...
    test_fixture(
        ...
        "hoist_query_selections/fixtures/nested_conditions.expected",
        input,
        expected,
    )
    .await;
...
async fn conditional_fragment_with_query_field() {
    let input = include_str!(
        "hoist_query_selections/fixtures/conditional_fragment_with_query_field.graphql"
    );
    let expected = include_str!(
        "hoist_query_selections/fixtures/conditional_fragment_with_query_field.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "conditional_fragment_with_query_field.graphql",
        "hoist_query_selections/fixtures/conditional_fragment_with_query_field.expected",
        input,
        expected,
    )
...
async fn conditional_inside_query_field() {
    let input =
        include_str!("hoist_query_selections/fixtures/conditional_inside_query_field.graphql");
    let expected =
        include_str!("hoist_query_selections/fixtures/conditional_inside_query_field.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "conditional_inside_query_field.graphql",
        "hoist_query_selections/fixtures/conditional_inside_query_field.expected",
        input,
        expected,
    )
    .await;
...
async fn duplicate_root_field() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "duplicate_root_field.graphql",
        "hoist_query_selections/fixtures/duplicate_root_field.expected",
        input,
        expected,
    )
    .await;
...
#[tokio::test]
async fn duplicate_root_field_with_condition() {
    let input =
        include_str!("hoist_query_selections/fixtures/duplicate_root_field_with_condition.graphql");
    let expected = include_str!(
        "hoist_query_selections/fixtures/duplicate_root_field_with_condition.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "duplicate_root_field_with_condition.graphql",
        "hoist_query_selections/fixtures/duplicate_root_field_with_condition.expected",
        input,
        expected,
    )
...
async fn mutation_error() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "mutation_error.graphql",
        "hoist_query_selections/fixtures/mutation_error.expected",
        input,
        expected,
    )
    .await;
