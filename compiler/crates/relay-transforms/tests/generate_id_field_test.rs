...
async fn abstract_plural() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "abstract-plural.graphql",
        "generate_id_field/fixtures/abstract-plural.expected",
        input,
        expected,
    )
    .await;
...
async fn node_union() {
    ...
    test_fixture(
        ...
        file!(),
        "node-union.graphql",
        "generate_id_field/fixtures/node-union.expected",
        input,
        expected,
    )
    .await;
...
async fn non_node_union() {
    ...
    test_fixture(
        ...
        "generate_id_field/fixtures/non-node-union.expected",
        input,
        expected,
    )
    .await;
...
async fn query_with_fragment_variables() {
    ...
    let expected =
        include_str!("generate_id_field/fixtures/query-with-fragment-variables.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "query-with-fragment-variables.graphql",
        "generate_id_field/fixtures/query-with-fragment-variables.expected",
        input,
        expected,
    )
    .await;
