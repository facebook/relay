...
describe.each([
  ...
  describe('pagination', () => {
    ...
    describe('loadNext', () => {
      ...
      test('does not load more if fragment ref passed to usePaginationFragment() was null', () => {
        const warning = require('warning');
        // $FlowFixMe[prop-missing]
        warning.mockClear();
      ...
      describe('when parent query is streaming', () => {
        ...
        test('does not start pagination request even if query is no longer active but loadNext is bound to snapshot of data while query was active', () => {
          const {
            __internal: {fetchQuery},
          } = require('relay-runtime');
