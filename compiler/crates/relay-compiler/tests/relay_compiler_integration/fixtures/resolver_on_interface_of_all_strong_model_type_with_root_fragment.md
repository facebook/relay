...
>*/);
```
```js title="__generated__/IPersonResolversFragment.graphql.js"
/**
...
export type IPersonResolversFragment$data = {|
  +name: ?string,
  +$fragmentType: IPersonResolversFragment$fragmentType,
|};
export type IPersonResolversFragment$key = {
  +$data?: IPersonResolversFragment$data,
  +$fragmentSpreads: IPersonResolversFragment$fragmentType,
  ...
};
*/
...
import {name as visitorNameResolver} from 'IPersonResolvers';

var node/*: ReaderFragment*/ = (function(){
var v0 = {
  "args": null,
  "kind": "FragmentSpread",
  "name": "IPersonResolversFragment"
};
return {
  "argumentDefinitions": [],
  "kind": "Fragment",
          ...
          "selections": [
            {
              ...
              "kind": "RelayResolver",
              "name": "name",
              "resolverModule": visitorNameResolver,
              "path": "name"
            }
          ],
          "type": "Visitor",
          ...
          "selections": [
            {
              ...
              "kind": "RelayResolver",
              "name": "name",
              "resolverModule": adminNameResolver,
              "path": "name"
            }
          ],
          "type": "Admin",
          ...
          "selections": [
            {
              ...
              "kind": "RelayResolver",
              "name": "name",
              "resolverModule": userNameResolver,
              "path": "name"
            }
          ],
          "type": "User",
...
export default ((node/*: any*/)/*: Fragment<
  IPersonResolversFragment$fragmentType,
  IPersonResolversFragment$data,
>*/);
```
...
Project: default
  Type: Mapping
  - Source: ExecutableDefinition: IPersonResolversFragment
    Path: __generated__/IPersonResolversFragment.graphql.js
