...
describe('RelayMutationTransaction', () => {
  ...
  describe('constructor', () => {
    ...
    it('does not update store if there is no optimistic response', () => {
      var transaction = new RelayMutationTransaction(mockMutation, storeData);
    ...
    it('infers optimistic query if mutation does not have one', () => {
      ...
      new RelayMutationTransaction(mockMutation, storeData);
  ...
  describe('commit', () => {
    ...
    it('throws if commit is called more than once', () => {
      var transaction = new RelayMutationTransaction(mockMutation1, storeData);
      transaction.commit();
    ...
    it('calls `onSuccess` with response', () => {
      var transaction1 = new RelayMutationTransaction(mockMutation1, storeData);
    ...
    it('queues commits for colliding transactions', () => {
      ...
      var transaction2 = new RelayMutationTransaction(mockMutation1, storeData);
      transaction2.commit();
    ...
    it('does not queue commits for non-colliding transactions', () => {
      ...
      var transaction2 = new RelayMutationTransaction(mockMutation2, storeData);
      transaction2.commit();
    ...
    it('does not queue commits for `null` collision key transactions', () => {
      var transaction1 = new RelayMutationTransaction(mockMutation3, storeData);
      transaction1.commit();
      ...
      var transaction2 = new RelayMutationTransaction(mockMutation3, storeData);
      transaction2.commit();
    ...
    it('empties collision queue after a failure', () => {
      ...
      var transaction3 = new RelayMutationTransaction(mockMutation1, storeData);
      transaction3.commit();
    ...
    it('auto-rollbacks colliding queued transactions upon failure, unless prevented', () => {
      ...
      var transaction4 = new RelayMutationTransaction(mockMutation2, storeData);
      transaction4.commit({onFailure: failureCallback4});

      var failureCallback5 = jest.genMockFunction().mockImplementation();
      var transaction5 = new RelayMutationTransaction(mockMutation2, storeData);
  ...
  describe('recommit', () => {
    ...
    it('re-queues the transaction', () => {
      var transaction1 = new RelayMutationTransaction(mockMutation, storeData);
      var successCallback1 = jest.genMockFunction();
      var failureCallback1 = jest.genMockFunction().mockImplementation(
        (transaction, preventAutoRollback) => {
          preventAutoRollback();
      ...
      var transaction2 = new RelayMutationTransaction(mockMutation, storeData);
