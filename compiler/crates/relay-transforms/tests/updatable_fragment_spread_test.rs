...
async fn updatable_fragment_spread_aliased_inline_fragment_in_linked_field() {
    ...
    test_fixture(transform_fixture, file!(), "updatable_fragment_spread_aliased_inline_fragment_in_linked_field.graphql", "updatable_fragment_spread/fixtures/updatable_fragment_spread_aliased_inline_fragment_in_linked_field.expected", input, expected).await;
}

#[tokio::test]
async fn updatable_fragment_spread_aliased_inline_fragment_top_level() {
    let input = include_str!("updatable_fragment_spread/fixtures/updatable_fragment_spread_aliased_inline_fragment_top_level.graphql");
    let expected = include_str!("updatable_fragment_spread/fixtures/updatable_fragment_spread_aliased_inline_fragment_top_level.expected");
    test_fixture(transform_fixture, file!(), "updatable_fragment_spread_aliased_inline_fragment_top_level.graphql", "updatable_fragment_spread/fixtures/updatable_fragment_spread_aliased_inline_fragment_top_level.expected", input, expected).await;
}

#[tokio::test]
async fn updatable_fragment_spread_aliased_inline_fragment_wrong_type_invalid() {
