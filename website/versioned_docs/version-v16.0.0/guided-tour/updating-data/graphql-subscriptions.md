...
[GraphQL subscriptions](https://www.internalfb.com/intern/wiki/GraphQL_Subscriptions/) are a mechanism to allow clients to query for data in response to a stream of server-side events.
