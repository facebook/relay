...
pub struct CodegenConstants {
    ...
    pub has_server_field: StringKey,
    pub id: StringKey,
...
pub static CODEGEN_CONSTANTS: LazyLock<CodegenConstants> = LazyLock::new(|| CodegenConstants {
    ...
    abstract_inline: "AbstractInline".intern(),
    ...
    has_server_field: "hasServerField".intern(),
    id: "id".intern(),
    ...
    inline_kinds: "inlineKinds".intern(),
