...
async fn base_definitions_change_fragment() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "base-definitions-change-fragment.graphql",
        "ir/fixtures/base-definitions-change-fragment.expected",
        input,
        expected,
    )
    .await;
...
async fn base_definitions_change_fragment2() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "base-definitions-change-fragment2.graphql",
        "ir/fixtures/base-definitions-change-fragment2.expected",
        input,
        expected,
    )
    .await;
...
async fn base_definitions_change_query() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "base-definitions-change-query.graphql",
        "ir/fixtures/base-definitions-change-query.expected",
        input,
        expected,
    )
    .await;
...
async fn definitions_only_change_fragment() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "definitions-only-change-fragment.graphql",
        "ir/fixtures/definitions-only-change-fragment.expected",
        input,
        expected,
    )
    .await;
...
async fn definitions_only_change_query() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "definitions-only-change-query.graphql",
        "ir/fixtures/definitions-only-change-query.expected",
        input,
        expected,
    )
    .await;
...
async fn definitions_only_no_change() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "definitions-only-no-change.graphql",
        "ir/fixtures/definitions-only-no-change.expected",
        input,
        expected,
    )
    .await;
...
async fn implicit_dependencies_parent_child() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "implicit-dependencies-parent-child.graphql",
        "ir/fixtures/implicit-dependencies-parent-child.expected",
        input,
        expected,
    )
    .await;
...
async fn new_resolver_field() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "new-resolver-field.graphql",
        "ir/fixtures/new-resolver-field.expected",
        input,
        expected,
    )
    .await;
...
async fn new_resolver_model_field() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "new-resolver-model-field.graphql",
        "ir/fixtures/new-resolver-model-field.expected",
        input,
        expected,
    )
    .await;
...
async fn new_resolver_model_field_with_custom_fragment() {
    ...
    let expected =
        include_str!("ir/fixtures/new-resolver-model-field-with-custom-fragment.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "new-resolver-model-field-with-custom-fragment.graphql",
...
async fn new_resolver_on_interface() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "new-resolver-on-interface.graphql",
        "ir/fixtures/new-resolver-on-interface.expected",
        input,
        expected,
    )
    .await;
...
async fn recursive_fragments() {
    ...
    test_fixture(
        ...
        "ir/fixtures/recursive-fragments.expected",
        input,
        expected,
    )
    .await;
...
async fn scalar_field_argument_enum_change() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "scalar-field-argument-enum-change.graphql",
        "ir/fixtures/scalar-field-argument-enum-change.expected",
        input,
        expected,
    )
    .await;
...
async fn schema_and_definitions_change() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "schema-and-definitions-change.graphql",
        "ir/fixtures/schema-and-definitions-change.expected",
        input,
        expected,
    )
    .await;
...
async fn schema_enum_and_object_change() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "schema-enum-and-object-change.graphql",
        "ir/fixtures/schema-enum-and-object-change.expected",
        input,
        expected,
    )
    .await;
...
async fn schema_enum_change() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "schema-enum-change.graphql",
        "ir/fixtures/schema-enum-change.expected",
        input,
        expected,
    )
    .await;
...
async fn schema_enum_in_input_object_change() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "schema-enum-in-input-object-change.graphql",
        "ir/fixtures/schema-enum-in-input-object-change.expected",
        input,
        expected,
    )
    .await;
...
async fn schema_field_return_type_change() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "schema-field-return-type-change.graphql",
        "ir/fixtures/schema-field-return-type-change.expected",
        input,
        expected,
    )
    .await;
...
async fn schema_object_change() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "schema-object-change.graphql",
        "ir/fixtures/schema-object-change.expected",
        input,
        expected,
    )
    .await;
...
async fn schema_object_change_without_field_return_types() {
    ...
    let expected =
        include_str!("ir/fixtures/schema-object-change-without-field-return-types.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "schema-object-change-without-field-return-types.graphql",
        "ir/fixtures/schema-object-change-without-field-return-types.expected",
        input,
        expected,
    )
    .await;
...
async fn schema_object_in_union_change() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "schema-object-in-union-change.graphql",
        "ir/fixtures/schema-object-in-union-change.expected",
        input,
        expected,
    )
    .await;
...
async fn schema_object_with_interface_change() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "schema-object-with-interface-change.graphql",
        "ir/fixtures/schema-object-with-interface-change.expected",
        input,
        expected,
    )
    .await;
...
async fn schema_recursive_input_type_change() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "schema-recursive-input-type-change.graphql",
        "ir/fixtures/schema-recursive-input-type-change.expected",
        input,
        expected,
    )
    .await;
...
async fn schema_union_change() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "schema-union-change.graphql",
        "ir/fixtures/schema-union-change.expected",
        input,
        expected,
    )
    .await;
...
async fn transitive_implicit_dependency() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "transitive-implicit-dependency.graphql",
        "ir/fixtures/transitive-implicit-dependency.expected",
        input,
        expected,
    )
    .await;
