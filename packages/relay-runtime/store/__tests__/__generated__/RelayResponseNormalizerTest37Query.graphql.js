 ...
 * @oncall relay
 *
 * @generated SignedSource<<8426db4f977bb65670f6e9650f0f12a7>>
 * @flow
...
export type RelayResponseNormalizerTest37Query$variables = {|
  id: string,
|};
...
export type RelayResponseNormalizerTest37Query = {|
  ...
  variables: RelayResponseNormalizerTest37Query$variables,
|};
*/
...
return {
  ...
  "params": {
    "cacheID": "a46f2c38633722c2c4e220e7f9c6a9c2",
    "id": null,
    "metadata": {},
    "name": "RelayResponseNormalizerTest37Query",
    "operationKind": "query",
    "text": "query RelayResponseNormalizerTest37Query(\n  $id: ID!\n) {\n  node(id: $id) {\n    id\n    __typename\n    ... on User {\n      firstName\n      lastName\n      friends(first: 3) {\n        edges {\n          cursor\n          node {\n            firstName\n            lastName\n            id\n          }\n        }\n      }\n    }\n  }\n}\n"
  }
};
})();
