...
async fn alias() {
    ...
    test_fixture(
        ...
        file!(),
        "alias.graphql",
        "inline_data_fragment/fixtures/alias.expected",
        input,
        expected,
    )
    .await;
...
async fn dangerously_unaliased() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "dangerously_unaliased.graphql",
        "inline_data_fragment/fixtures/dangerously_unaliased.expected",
        input,
        expected,
    )
    .await;
...
async fn recursive() {
    ...
    test_fixture(
        ...
        file!(),
        "recursive.graphql",
        "inline_data_fragment/fixtures/recursive.expected",
        input,
        expected,
    )
    .await;
...
async fn variables() {
    ...
    test_fixture(
        ...
        file!(),
        "variables.graphql",
        "inline_data_fragment/fixtures/variables.expected",
        input,
        expected,
    )
    .await;
