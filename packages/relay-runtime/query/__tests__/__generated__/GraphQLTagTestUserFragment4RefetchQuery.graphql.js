 ...
 *
 * @generated SignedSource<<3ded99fa304dcf8c724df2c8efb3ffed>>
 * @flow
...
export type GraphQLTagTestUserFragment4RefetchQuery$variables = {|
  ...
  id: string,
|};
export type GraphQLTagTestUserFragment4RefetchQueryVariables = GraphQLTagTestUserFragment4RefetchQuery$variables;
export type GraphQLTagTestUserFragment4RefetchQuery$data = {|
  +node: ?{|
    +$fragmentRefs: GraphQLTagTest6UserFragment$fragmentType,
    +$fragmentSpreads: GraphQLTagTest6UserFragment$fragmentType,
  |},
|};
export type GraphQLTagTestUserFragment4RefetchQueryResponse = GraphQLTagTestUserFragment4RefetchQuery$data;
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "GraphQLTagTestUserFragment4RefetchQuery",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    "cacheID": "4dd6f787d5581421e72565305c83006f",
    "id": null,
    "metadata": {},
    "name": "GraphQLTagTestUserFragment4RefetchQuery",
    "operationKind": "query",
    "text": "query GraphQLTagTestUserFragment4RefetchQuery(\n  $after: ID\n  $first: Int\n  $id: ID!\n) {\n  node(id: $id) {\n    __typename\n    ...GraphQLTagTest6UserFragment\n    id\n  }\n}\n\nfragment GraphQLTagTest6UserFragment on User {\n  id\n  name\n  friends(after: $after, first: $first) {\n    edges {\n      node {\n        id\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}\n"
  }
};
})();
