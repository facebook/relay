...
describe('readRelayQueryData', () => {
  ...
  it('populates data ID for nodes containing only non-local fragments', () => {
    ...
    var data = readData(getStoreData({records}), query, 'client:1');
    var pointer = data[getNode(fragmentReference).getStructuralHash()];
  ...
  it('recurses through fragments when retrieving pageInfo', () => {
    ...
    var fragmentPointer = data.comments.pageInfo[
      getNode(fragmentReference).getStructuralHash()
    ];
  ...
  it('returns GraphQLFragmentPointers for child queries', () => {
    ...
    var namePointer1 =
      screennames[0][getNode(fragmentReference).getStructuralHash()];
    var namePointer2 =
      screennames[1][getNode(fragmentReference).getStructuralHash()];
  ...
  it('parses range client IDs', () => {
    ...
    expect(data).toEqual({
      ...
      friends: {
        ...
        [getNode(fragmentReference).getStructuralHash()]: pointer,
      },
    });
