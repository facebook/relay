...
async fn client_fields_of_client_type() {
    ...
    test_fixture(
        ...
        "client_extensions/fixtures/client-fields-of-client-type.expected",
        input,
        expected,
    )
    .await;
...
async fn client_linked_fields() {
    ...
    test_fixture(
        ...
        "client_extensions/fixtures/client-linked-fields.expected",
        input,
        expected,
    )
    .await;
...
async fn client_scalar_fields() {
    ...
    test_fixture(
        ...
        "client_extensions/fixtures/client-scalar-fields.expected",
        input,
        expected,
    )
    .await;
