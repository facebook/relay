...
async fn enum_type() {
    ...
    test_fixture(
        ...
        file!(),
        "enum_type.json",
        "type_information/fixtures/enum_type.expected",
        input,
        expected,
    )
    .await;
...
async fn filter_case_insensitive() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "filter_case_insensitive.json",
        "type_information/fixtures/filter_case_insensitive.expected",
        input,
        expected,
    )
    .await;
...
async fn filter_no_matches() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "filter_no_matches.json",
        "type_information/fixtures/filter_no_matches.expected",
        input,
        expected,
    )
    .await;
...
async fn input_object() {
    ...
    test_fixture(
        ...
        file!(),
        "input_object.json",
        "type_information/fixtures/input_object.expected",
        input,
        expected,
    )
    .await;
...
async fn interface_type() {
    ...
    test_fixture(
        ...
        file!(),
        "interface_type.json",
        "type_information/fixtures/interface_type.expected",
        input,
        expected,
    )
    .await;
...
async fn interface_with_implements() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "interface_with_implements.json",
        "type_information/fixtures/interface_with_implements.expected",
        input,
        expected,
    )
    .await;
...
async fn massive_type() {
    ...
    test_fixture(
        ...
        file!(),
        "massive_type.json",
        "type_information/fixtures/massive_type.expected",
        input,
        expected,
    )
    .await;
...
async fn massive_type_filtered() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "massive_type_filtered.json",
        "type_information/fixtures/massive_type_filtered.expected",
        input,
        expected,
    )
    .await;
...
async fn object_type() {
    ...
    test_fixture(
        ...
        file!(),
        "object_type.json",
        "type_information/fixtures/object_type.expected",
        input,
        expected,
    )
    .await;
...
async fn scalar_type() {
    ...
    test_fixture(
        ...
        file!(),
        "scalar_type.json",
        "type_information/fixtures/scalar_type.expected",
        input,
        expected,
    )
    .await;
...
async fn union_type() {
    ...
    test_fixture(
        ...
        file!(),
        "union_type.json",
        "type_information/fixtures/union_type.expected",
        input,
        expected,
    )
    .await;
