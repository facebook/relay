...
async fn base_definitions() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "base-definitions.graphql",
        "ast/fixtures/base-definitions.expected",
        input,
        expected,
    )
    .await;
...
async fn definitions_only() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "definitions-only.graphql",
        "ast/fixtures/definitions-only.expected",
        input,
        expected,
    )
    .await;
...
async fn missing_fragments() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "missing-fragments.graphql",
        "ast/fixtures/missing-fragments.expected",
        input,
        expected,
    )
    .await;
...
async fn multiple_base_definitions() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "multiple-base-definitions.graphql",
        "ast/fixtures/multiple-base-definitions.expected",
        input,
        expected,
    )
    .await;
