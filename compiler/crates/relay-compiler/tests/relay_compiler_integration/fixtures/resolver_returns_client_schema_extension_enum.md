...
```js title="__generated__/SomeComponentFragment.graphql.js"
/**
...
Project: default
  Type: Mapping
  - Source: ExecutableDefinition: SomeComponentFragment
    Path: __generated__/SomeComponentFragment.graphql.js
