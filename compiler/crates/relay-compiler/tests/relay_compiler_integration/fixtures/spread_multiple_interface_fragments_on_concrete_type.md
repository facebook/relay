...
```js title="__generated__/ActorComponentFragment.graphql.js"
/**
 * <auto-generated> SignedSource<<8ecf1496c9be81fba75d8d8bf501e19b>>
 * @flow
          ...
          "selections": [
            {
              ...
              "kind": "RelayResolver",
              "name": "description",
              "resolverModule": resolverDataInjector(Admin____relay_model_instance_graphql, adminDescriptionResolver, '__relay_model_instance', true),
              "path": "description"
            }
          ],
          "type": "Admin",
          ...
          "selections": [
            {
              ...
              "kind": "RelayResolver",
              "name": "description",
              "resolverModule": resolverDataInjector(User____relay_model_instance_graphql, userDescriptionResolver, '__relay_model_instance', true),
              "path": "description"
            }
          ],
          "type": "User",
...
>*/);
```
```js title="__generated__/Admin____relay_model_instance.graphql.js"
/**
 * <auto-generated> SignedSource<<457e4c1761d560800eb37b16bfca065f>>
 * @flow
 * @lightSyntaxTransform
 * @nogrep
 */
...
export type Admin____relay_model_instance$data = {|
  +__relay_model_instance: NonNullable<ReturnType<typeof adminRelayModelInstanceResolverType>>,
  ...
  "selections": [
    {
      ...
      "resolverModule": resolverDataInjector(Admin__id_graphql, adminRelayModelInstanceResolver, 'id', true),
...
>*/);
```
```js title="__generated__/Admin__id.graphql.js"
/**
 * <auto-generated> SignedSource<<78e97d08242ee5ff28fb2c5bf850cd81>>
 * @flow
 * @lightSyntaxTransform
 * @nogrep
 */
...
>*/);
```
```js title="__generated__/PersonComponentFragment.graphql.js"
/**
...
>*/);
```
```js title="__generated__/SpreadInterfaceFragmentOnConcreteTypeComponentFragment.graphql.js"
/**
 * <auto-generated> SignedSource<<e636a69ca268f6143989bb0e25466d96>>
 * @flow
 * @lightSyntaxTransform
 * @nogrep
 */
...
>*/);
```
```js title="__generated__/User____relay_model_instance.graphql.js"
/**
 * <auto-generated> SignedSource<<e5ff690260b8930a18c2ff36336d3c37>>
 * @flow
 * @lightSyntaxTransform
 * @nogrep
 */
...
export type User____relay_model_instance$data = {|
  +__relay_model_instance: NonNullable<ReturnType<typeof userRelayModelInstanceResolverType>>,
...
>*/);
```
```js title="__generated__/User__id.graphql.js"
/**
...
Project: default
  Type: Mapping
  - Source: ExecutableDefinition: ActorComponentFragment
    Path: __generated__/ActorComponentFragment.graphql.js
  - Source: ExecutableDefinition: PersonComponentFragment
    Path: __generated__/PersonComponentFragment.graphql.js
  - Source: ExecutableDefinition: SpreadInterfaceFragmentOnConcreteTypeComponentFragment
    Path: __generated__/SpreadInterfaceFragmentOnConcreteTypeComponentFragment.graphql.js
  - Source: ResolverHash: ResolverSourceHash("9dd9e9fdd793726f021efa8f2602c3a0")
    Path: __generated__/User____relay_model_instance.graphql.js
    Path: __generated__/User__id.graphql.js
  - Source: ResolverHash: ResolverSourceHash("bb1ffe3e10eda807d79c3d58e800ca86")
    Path: __generated__/Admin____relay_model_instance.graphql.js
    Path: __generated__/Admin__id.graphql.js
