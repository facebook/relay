 ...
 */
export type CNormalizationSelector<TNormalizaionNode> = {
  dataID: DataID,
  node: TNormalizaionNode,
  variables: Variables,
};
 ...
 */
export type COperationSelector<TReaderNode, TNormalizaionNode, TRequest> = {
  fragment: CReaderSelector<TReaderNode>,
  node: TRequest,
  root: CNormalizationSelector<TNormalizaionNode>,
  variables: Variables,
};
...
> {
   ...
   * selector.
   */
  check(selector: CNormalizationSelector<TNormalizaionNode>): boolean;
   ...
   */
  retain(selector: CNormalizationSelector<TNormalizaionNode>): Disposable;
   ...
   */
  execute(config: {|
    operation: COperationSelector<TReaderNode, TNormalizaionNode, TRequest>,
...
> {
  ...
  createOperationSelector: (
    request: TRequest,
    variables: Variables,
  ) => COperationSelector<TReaderNode, TNormalizaionNode, TRequest>;
