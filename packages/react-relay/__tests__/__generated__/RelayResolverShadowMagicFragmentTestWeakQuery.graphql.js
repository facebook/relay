 ...
 * @oncall relay
 *
 * @generated SignedSource<<1ba97ba1e521605bcd0223425ccd091e>>
 * @flow
...
export type RelayResolverShadowMagicFragmentTestWeakQuery$variables = {};
export type RelayResolverShadowMagicFragmentTestWeakQuery$data = {
  readonly shadow_magic_thing: ?{
    readonly city: ?string,
  },
};
export type RelayResolverShadowMagicFragmentTestWeakQuery = {
  response: RelayResolverShadowMagicFragmentTestWeakQuery$data,
  variables: RelayResolverShadowMagicFragmentTestWeakQuery$variables,
};
*/
...
return {
  "fragment": {
    ...
    "name": "RelayResolverShadowMagicFragmentTestWeakQuery",
    "selections": [
      {
        ...
        "linkedField": {
          ...
          "storageKey": "shadow_magic_thing(force_weak:true)"
        }
      }
    ],
    "type": "Query",
  ...
  "params": {
    "cacheID": "f423b21534197f4a2e8478dad4496673",
    "id": null,
    "metadata": {},
    "name": "RelayResolverShadowMagicFragmentTestWeakQuery",
    "operationKind": "query",
    "text": "query RelayResolverShadowMagicFragmentTestWeakQuery {\n  ...ShadowMagicThingResolver_RootFragment\n  me {\n    address {\n      city\n      __typename\n    }\n    id\n  }\n}\n\nfragment ShadowMagicThingResolver_RootFragment on Query {\n  me {\n    address {\n      city\n      __typename\n    }\n    id\n  }\n}\n"
  }
};
})();

if (__DEV__) {
  (node/*:: as any*/).hash = "9099726d80b58b9f03b22068c59e6e5f";
}

module.exports = ((node/*:: as any*/)/*:: as Query<
  RelayResolverShadowMagicFragmentTestWeakQuery$variables,
  RelayResolverShadowMagicFragmentTestWeakQuery$data,
>*/);
