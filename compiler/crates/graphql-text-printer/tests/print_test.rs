 ...
 *
 * @generated SignedSource<<f238c8997f6e9bd5416a080adb097338>>
 */
...
async fn basic_arg_defs() {
    ...
    test_fixture(transform_fixture, file!(), "basic_arg_defs.graphql", "print/fixtures/basic_arg_defs.expected", input, expected).await;
}
...
async fn basic_directives() {
    ...
    test_fixture(transform_fixture, file!(), "basic_directives.graphql", "print/fixtures/basic_directives.expected", input, expected).await;
}
...
async fn basic_fragment() {
    ...
    test_fixture(transform_fixture, file!(), "basic_fragment.graphql", "print/fixtures/basic_fragment.expected", input, expected).await;
}
...
async fn basic_inline_fragments() {
    ...
    test_fixture(transform_fixture, file!(), "basic_inline_fragments.graphql", "print/fixtures/basic_inline_fragments.expected", input, expected).await;
}
...
async fn basic_list_object_values() {
    ...
    test_fixture(transform_fixture, file!(), "basic_list_object_values.graphql", "print/fixtures/basic_list_object_values.expected", input, expected).await;
}
...
async fn basic_query() {
    ...
    test_fixture(transform_fixture, file!(), "basic_query.graphql", "print/fixtures/basic_query.expected", input, expected).await;
}
...
async fn basic_var_defs() {
    ...
    test_fixture(transform_fixture, file!(), "basic_var_defs.graphql", "print/fixtures/basic_var_defs.expected", input, expected).await;
}
...
async fn conditions() {
    ...
    test_fixture(transform_fixture, file!(), "conditions.graphql", "print/fixtures/conditions.expected", input, expected).await;
}
...
async fn empty_args() {
    ...
    test_fixture(transform_fixture, file!(), "empty_args.graphql", "print/fixtures/empty_args.expected", input, expected).await;
}
...
async fn fragment_variables() {
    ...
    test_fixture(transform_fixture, file!(), "fragment_variables.graphql", "print/fixtures/fragment_variables.expected", input, expected).await;
}
...
async fn kitchen_sink() {
    ...
    test_fixture(transform_fixture, file!(), "kitchen-sink.graphql", "print/fixtures/kitchen-sink.expected", input, expected).await;
}
...
async fn nested_conditions() {
    ...
    test_fixture(transform_fixture, file!(), "nested_conditions.graphql", "print/fixtures/nested_conditions.expected", input, expected).await;
}
...
async fn single_value_array_of_objects() {
    ...
    test_fixture(transform_fixture, file!(), "single-value-array-of-objects.graphql", "print/fixtures/single-value-array-of-objects.expected", input, expected).await;
}
...
async fn string_enum_arg_invalid() {
    ...
    test_fixture(transform_fixture, file!(), "string-enum-arg.invalid.graphql", "print/fixtures/string-enum-arg.invalid.expected", input, expected).await;
}
...
async fn string_enum_fragment_arg() {
    ...
    test_fixture(transform_fixture, file!(), "string-enum-fragment-arg.graphql", "print/fixtures/string-enum-fragment-arg.expected", input, expected).await;
}
...
async fn string_enum_fragment_arg_with_complex_input() {
    ...
    test_fixture(transform_fixture, file!(), "string-enum-fragment-arg-with-complex-input.graphql", "print/fixtures/string-enum-fragment-arg-with-complex-input.expected", input, expected).await;
}
...
async fn unknown_enum_arg_invalid() {
    ...
    test_fixture(transform_fixture, file!(), "unknown-enum-arg.invalid.graphql", "print/fixtures/unknown-enum-arg.invalid.expected", input, expected).await;
}
