...
describe('RelayRecordStore', () => {
  ...
  describe('putRecord()', () => {
    it('creates records', () => {
      ...
      expect(cache.cacheField).toBeCalledWith('1', '__dataID__', '1', 'Type');
    });
