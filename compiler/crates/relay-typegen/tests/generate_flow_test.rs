 ...
 *
 * @generated SignedSource<<8d401c9a8a6709b100da0eb1e7db240e>>
 */
...
async fn typename_abstract_discriminated_unions() {
    let input = include_str!("generate_flow/fixtures/typename-abstract-discriminated-unions.graphql");
    let expected = include_str!("generate_flow/fixtures/typename-abstract-discriminated-unions.expected");
    test_fixture(transform_fixture, file!(), "typename-abstract-discriminated-unions.graphql", "generate_flow/fixtures/typename-abstract-discriminated-unions.expected", input, expected).await;
}

#[tokio::test]
async fn typename_abstract_discriminated_unions_disabled() {
    let input = include_str!("generate_flow/fixtures/typename-abstract-discriminated-unions-disabled.graphql");
    let expected = include_str!("generate_flow/fixtures/typename-abstract-discriminated-unions-disabled.expected");
    test_fixture(transform_fixture, file!(), "typename-abstract-discriminated-unions-disabled.graphql", "generate_flow/fixtures/typename-abstract-discriminated-unions-disabled.expected", input, expected).await;
}

#[tokio::test]
async fn typename_discriminated_unions() {
    let input = include_str!("generate_flow/fixtures/typename-discriminated-unions.graphql");
    let expected = include_str!("generate_flow/fixtures/typename-discriminated-unions.expected");
    test_fixture(transform_fixture, file!(), "typename-discriminated-unions.graphql", "generate_flow/fixtures/typename-discriminated-unions.expected", input, expected).await;
}
