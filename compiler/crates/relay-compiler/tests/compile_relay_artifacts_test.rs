 ...
 *
 * @generated SignedSource<<4f14b9c52d5e6010690b0aab04d24ce3>>
 */
...
fn flight_props_transform() {
    ...
    test_fixture(
        transform_fixture,
        "flight-props-transform.graphql",
        "compile_relay_artifacts/fixtures/flight-props-transform.expected",
        input,
        expected,
    );
}
...
fn match_with_variable_key_invalid() {
    let input =
        include_str!("compile_relay_artifacts/fixtures/match-with-variable-key.invalid.graphql");
    let expected =
        include_str!("compile_relay_artifacts/fixtures/match-with-variable-key.invalid.expected");
    test_fixture(
        transform_fixture,
        "match-with-variable-key.invalid.graphql",
        "compile_relay_artifacts/fixtures/match-with-variable-key.invalid.expected",
        input,
        expected,
    );
}
...
fn query_with_relay_client_component() {
    let input =
        include_str!("compile_relay_artifacts/fixtures/query-with-relay-client-component.graphql");
    let expected =
        include_str!("compile_relay_artifacts/fixtures/query-with-relay-client-component.expected");
    test_fixture(
        transform_fixture,
        "query-with-relay-client-component.graphql",
        "compile_relay_artifacts/fixtures/query-with-relay-client-component.expected",
        input,
        expected,
    );
}
...
fn refetchable_fragment_directives() {
    let input =
        include_str!("compile_relay_artifacts/fixtures/refetchable_fragment_directives.graphql");
    let expected =
        include_str!("compile_relay_artifacts/fixtures/refetchable_fragment_directives.expected");
    test_fixture(
        transform_fixture,
        "refetchable_fragment_directives.graphql",
        "compile_relay_artifacts/fixtures/refetchable_fragment_directives.expected",
        input,
        expected,
    );
}
...
fn subscription_transform() {
    ...
    test_fixture(
        transform_fixture,
        "subscription-transform.graphql",
        "compile_relay_artifacts/fixtures/subscription-transform.expected",
        input,
        expected,
    );
}
...
#[test]
fn required_under_connection() {
    let input = include_str!("compile_relay_artifacts/fixtures/required-under-connection.graphql");
    let expected =
        include_str!("compile_relay_artifacts/fixtures/required-under-connection.expected");
    test_fixture(
        transform_fixture,
        "required-under-connection.graphql",
        "compile_relay_artifacts/fixtures/required-under-connection.expected",
        input,
        expected,
    );
}
