...
async fn double_underscore_id_field() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "double_underscore_id_field.graphql",
        "hover/fixtures/double_underscore_id_field.expected",
        input,
        expected,
    )
    .await;
...
async fn double_underscore_typename_field() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "double_underscore_typename_field.graphql",
        "hover/fixtures/double_underscore_typename_field.expected",
        input,
        expected,
    )
    .await;
...
async fn fragment_definition_name() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "fragment_definition_name.graphql",
        "hover/fixtures/fragment_definition_name.expected",
        input,
        expected,
    )
    .await;
...
async fn fragment_spread() {
    ...
    test_fixture(
        ...
        "hover/fixtures/fragment_spread.expected",
        input,
        expected,
    )
    .await;
...
async fn scalar_field_from_client_schema_extension() {
    ...
    let expected =
        include_str!("hover/fixtures/scalar_field_from_client_schema_extension.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "scalar_field_from_client_schema_extension.graphql",
        "hover/fixtures/scalar_field_from_client_schema_extension.expected",
        input,
        expected,
    )
    .await;
...
async fn scalar_field_from_relay_resolver() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "scalar_field_from_relay_resolver.graphql",
        "hover/fixtures/scalar_field_from_relay_resolver.expected",
        input,
        expected,
    )
    .await;
...
async fn scalar_field_with_description() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "scalar_field_with_description.graphql",
        "hover/fixtures/scalar_field_with_description.expected",
        input,
        expected,
    )
    .await;
...
async fn whitespace_after_query_selection() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "whitespace_after_query_selection.graphql",
        "hover/fixtures/whitespace_after_query_selection.expected",
        input,
        expected,
    )
    .await;
...
async fn whitespace_within_linked_field_selection() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "whitespace_within_linked_field_selection.graphql",
        "hover/fixtures/whitespace_within_linked_field_selection.expected",
        input,
        expected,
    )
    .await;
