...
Whenever we’re going to make a transition that might cause new content to suspend, we should use the  [**`useTransition`**](https://reactjs.org/docs/getting-started.html#usetransition) to schedule the update for  transition:
...
For more details, check out the [React docs on Suspense](https://reactjs.org/docs/getting-started.html).
