...
pub static RELAY_RESOLVER_DIRECTIVE_NAME: LazyLock<DirectiveName> =
    LazyLock::new(|| DirectiveName("relay_resolver".intern()));
...
pub static RESOLVER_VALUE_SCALAR_NAME: LazyLock<ScalarName> =
    LazyLock::new(|| ScalarName("RelayResolverValue".intern()));
/// The name of the docblock tag that Relay looks for to determine if a field is a resolver.
/// @RelayResolver
pub static RELAY_RESOLVER_FIELD: LazyLock<StringKey> = LazyLock::new(|| "RelayResolver".intern());
/// The name of the docblock tag for defining a Relay Resolver type.
/// @relayType
pub static RELAY_TYPE_FIELD: LazyLock<StringKey> = LazyLock::new(|| "relayType".intern());
/// The name of the docblock tag for defining a Relay Resolver field.
/// @relayField
pub static RELAY_FIELD_FIELD: LazyLock<StringKey> = LazyLock::new(|| "relayField".intern());
...
pub static RELAY_RESOLVER_MODEL_DIRECTIVE_NAME: LazyLock<DirectiveName> =
    LazyLock::new(|| DirectiveName("__RelayResolverModel".intern()));
/// A field directive which indicates that the field is the generated ID field for a model type.
pub static RELAY_RESOLVER_MODEL_GENERATED_ID_FIELD_DIRECTIVE_NAME: LazyLock<DirectiveName> =
    LazyLock::new(|| DirectiveName("__RelayResolverModelGeneratedIDField".intern()));
...
pub static FRAGMENT_KEY_ARGUMENT_NAME: LazyLock<ArgumentName> =
    LazyLock::new(|| ArgumentName("fragment_name".intern()));
...
pub static TYPE_CONFIRMED_ARGUMENT_NAME: LazyLock<ArgumentName> =
    LazyLock::new(|| ArgumentName("type_confirmed".intern()));
...
pub static RESOLVER_PROPERTY_LOOKUP_NAME: LazyLock<ArgumentName> =
    LazyLock::new(|| ArgumentName("property_lookup_name".intern()));
...
pub static RELAY_RESOLVER_WEAK_OBJECT_DIRECTIVE: LazyLock<DirectiveName> =
    LazyLock::new(|| DirectiveName("__RelayWeakObject".intern()));
...
pub static LIVE_ARGUMENT_NAME: LazyLock<ArgumentName> =
    LazyLock::new(|| ArgumentName("live".intern()));
...
pub static IMPORT_NAME_ARGUMENT_NAME: LazyLock<ArgumentName> =
    LazyLock::new(|| ArgumentName("import_name".intern()));
...
pub static HAS_OUTPUT_TYPE_ARGUMENT_NAME: LazyLock<ArgumentName> =
    LazyLock::new(|| ArgumentName("has_output_type".intern()));
/// Argument name for the `@relay_resolver` directive attached to resolver's
...
pub static IMPORT_PATH_ARGUMENT_NAME: LazyLock<ArgumentName> =
    LazyLock::new(|| ArgumentName("import_path".intern()));
...
pub static INJECT_FRAGMENT_DATA_ARGUMENT_NAME: LazyLock<ArgumentName> =
    LazyLock::new(|| ArgumentName("inject_fragment_data".intern()));
...
pub static GENERATED_FRAGMENT_ARGUMENT_NAME: LazyLock<ArgumentName> =
    LazyLock::new(|| ArgumentName("generated_fragment".intern()));
...
/// as deprecated.
pub static DEPRECATED_FIELD: LazyLock<StringKey> = LazyLock::new(|| "deprecated".intern());
...
pub static LIVE_FIELD: LazyLock<StringKey> = LazyLock::new(|| "live".intern());
...
/// for something else)
pub static RELAY_RESOLVER_MODEL_INSTANCE_FIELD: LazyLock<StringKey> =
    LazyLock::new(|| "__relay_model_instance".intern());
/// Name of docblock tag used to indicate that a resolver reads data from a
/// fragment, and what the name of that fragment is.
pub static ROOT_FRAGMENT_FIELD: LazyLock<StringKey> = LazyLock::new(|| "rootFragment".intern());
...
pub static SHADOW_RETURN_DIRECTIVE_NAME: LazyLock<DirectiveName> =
    LazyLock::new(|| DirectiveName("__relay_shadow_return".intern()));
...
pub static SHADOW_RETURN_FRAGMENT_ARGUMENT_NAME: LazyLock<ArgumentName> =
    LazyLock::new(|| ArgumentName("fragment".intern()));
...
pub static WEAK_FIELD: LazyLock<StringKey> = LazyLock::new(|| "weak".intern());
pub static EMPTY_STRING: LazyLock<StringKey> = LazyLock::new(|| "".intern());
...
pub static ARGUMENT_DEFINITIONS: LazyLock<DirectiveName> =
    LazyLock::new(|| DirectiveName("argumentDefinitions".intern()));
/// The following are arguments used by the above `@argumentDefinitions`.
pub static ARGUMENT_TYPE: LazyLock<StringKey> = LazyLock::new(|| "type".intern());
pub static DEFAULT_VALUE: LazyLock<StringKey> = LazyLock::new(|| "defaultValue".intern());
pub static PROVIDER_ARG_NAME: LazyLock<StringKey> = LazyLock::new(|| "provider".intern());
...
pub static KEY_RESOLVER_ID_FIELD: LazyLock<StringKey> = LazyLock::new(|| "id".intern());
...
///
/// See D48588439
pub static RELAY_RESOLVER_SOURCE_HASH: LazyLock<DirectiveName> =
    LazyLock::new(|| DirectiveName("resolver_source_hash".intern()));
/// Argument name used with @resolver_source_hash to specify the hash value.
pub static RELAY_RESOLVER_SOURCE_HASH_VALUE: LazyLock<ArgumentName> =
    LazyLock::new(|| ArgumentName("value".intern()));
